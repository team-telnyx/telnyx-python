...
@nested_resource_class_methods(
    "update_emergency_settings", path="/v2/phone_numbers/jobs/update_emergency_settings", operations=["create"]
)
@nested_resource_class_methods(
    "update_phone_numbers", path="/v2/phone_numbers/jobs/update_phone_numbers", operations=["create"]
)
@nested_resource_class_methods(
    "delete_phone_numbers", path="/v2/phone_numbers/jobs/delete_phone_numbers", operations=["create"]
)
