...
def load_object_classes():
    ...
    OBJECT_CLASSES = {
        ...
        api_resources.MessagingSenderId.OBJECT_NAME: api_resources.MessagingSenderId,
        api_resources.MessagingShortCode.OBJECT_NAME: api_resources.MessagingShortCode,
