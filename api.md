...
- <code title="get /addresses">client.addresses.<a href="./src/telnyx/resources/addresses/addresses.py">list</a>(\*\*<a href="src/telnyx/types/address_list_params.py">params</a>) -> <a href="./src/telnyx/types/address.py">SyncDefaultFlatPagination[Address]</a></code>
...
```python
from telnyx.types import AdvancedOrder, AdvancedOrderRequest, AdvancedOrderListResponse
```

Methods:

- <code title="post /advanced_orders">client.advanced_orders.<a href="./src/telnyx/resources/advanced_orders.py">create</a>(\*\*<a href="src/telnyx/types/advanced_order_create_params.py">params</a>) -> <a href="./src/telnyx/types/advanced_order.py">AdvancedOrder</a></code>
- <code title="get /advanced_orders/{order_id}">client.advanced_orders.<a href="./src/telnyx/resources/advanced_orders.py">retrieve</a>(order_id) -> <a href="./src/telnyx/types/advanced_order.py">AdvancedOrder</a></code>
...
- <code title="get /ai/assistants/tags">client.ai.assistants.tags.<a href="./src/telnyx/resources/ai/assistants/tags.py">list</a>() -> <a href="./src/telnyx/types/ai/assistants/tags_response.py">TagsResponse</a></code>
- <code title="post /ai/assistants/{assistant_id}/tags">client.ai.assistants.tags.<a href="./src/telnyx/resources/ai/assistants/tags.py">add</a>(assistant_id, \*\*<a href="src/telnyx/types/ai/assistants/tag_add_params.py">params</a>) -> <a href="./src/telnyx/types/ai/assistants/tags_response.py">TagsResponse</a></code>
- <code title="delete /ai/assistants/{assistant_id}/tags/{tag}">client.ai.assistants.tags.<a href="./src/telnyx/resources/ai/assistants/tags.py">remove</a>(tag, \*, assistant_id) -> <a href="./src/telnyx/types/ai/assistants/tags_response.py">TagsResponse</a></code>
...
- <code title="get /ai/integrations/{integration_id}">client.ai.integrations.<a href="./src/telnyx/resources/ai/integrations/integrations.py">retrieve</a>(integration_id) -> <a href="./src/telnyx/types/ai/integration.py">Integration</a></code>
...
```python
from telnyx.types.ai import McpServer
```

Methods:

- <code title="post /ai/mcp_servers">client.ai.mcp_servers.<a href="./src/telnyx/resources/ai/mcp_servers.py">create</a>(\*\*<a href="src/telnyx/types/ai/mcp_server_create_params.py">params</a>) -> <a href="./src/telnyx/types/ai/mcp_server.py">McpServer</a></code>
- <code title="get /ai/mcp_servers/{mcp_server_id}">client.ai.mcp_servers.<a href="./src/telnyx/resources/ai/mcp_servers.py">retrieve</a>(mcp_server_id) -> <a href="./src/telnyx/types/ai/mcp_server.py">McpServer</a></code>
- <code title="put /ai/mcp_servers/{mcp_server_id}">client.ai.mcp_servers.<a href="./src/telnyx/resources/ai/mcp_servers.py">update</a>(mcp_server_id, \*\*<a href="src/telnyx/types/ai/mcp_server_update_params.py">params</a>) -> <a href="./src/telnyx/types/ai/mcp_server.py">McpServer</a></code>
- <code title="get /ai/mcp_servers">client.ai.mcp_servers.<a href="./src/telnyx/resources/ai/mcp_servers.py">list</a>(\*\*<a href="src/telnyx/types/ai/mcp_server_list_params.py">params</a>) -> <a href="./src/telnyx/types/ai/mcp_server.py">SyncDefaultFlatPaginationTopLevelArray[McpServer]</a></code>
...
```python
from telnyx.types.ai import EventsListResponse, ExecutionMode, MissionData, MissionResponse
```

Methods:

- <code title="post /ai/missions">client.ai.missions.<a href="./src/telnyx/resources/ai/missions/missions.py">create</a>(\*\*<a href="src/telnyx/types/ai/mission_create_params.py">params</a>) -> <a href="./src/telnyx/types/ai/mission_response.py">MissionResponse</a></code>
- <code title="get /ai/missions/{mission_id}">client.ai.missions.<a href="./src/telnyx/resources/ai/missions/missions.py">retrieve</a>(mission_id) -> <a href="./src/telnyx/types/ai/mission_response.py">MissionResponse</a></code>
...
- <code title="put /ai/missions/{mission_id}">client.ai.missions.<a href="./src/telnyx/resources/ai/missions/missions.py">update_mission</a>(mission_id, \*\*<a href="src/telnyx/types/ai/mission_update_mission_params.py">params</a>) -> <a href="./src/telnyx/types/ai/mission_response.py">MissionResponse</a></code>
...
- <code title="post /ai/missions/{mission_id}/runs">client.ai.missions.runs.<a href="./src/telnyx/resources/ai/missions/runs/runs.py">create</a>(mission_id, \*\*<a href="src/telnyx/types/ai/missions/run_create_params.py">params</a>) -> <a href="./src/telnyx/types/ai/missions/mission_run_response.py">MissionRunResponse</a></code>
- <code title="get /ai/missions/{mission_id}/runs/{run_id}">client.ai.missions.runs.<a href="./src/telnyx/resources/ai/missions/runs/runs.py">retrieve</a>(run_id, \*, mission_id) -> <a href="./src/telnyx/types/ai/missions/mission_run_response.py">MissionRunResponse</a></code>
- <code title="patch /ai/missions/{mission_id}/runs/{run_id}">client.ai.missions.runs.<a href="./src/telnyx/resources/ai/missions/runs/runs.py">update</a>(run_id, \*, mission_id, \*\*<a href="src/telnyx/types/ai/missions/run_update_params.py">params</a>) -> <a href="./src/telnyx/types/ai/missions/mission_run_response.py">MissionRunResponse</a></code>
...
- <code title="post /ai/missions/{mission_id}/runs/{run_id}/cancel">client.ai.missions.runs.<a href="./src/telnyx/resources/ai/missions/runs/runs.py">cancel_run</a>(run_id, \*, mission_id) -> <a href="./src/telnyx/types/ai/missions/mission_run_response.py">MissionRunResponse</a></code>
...
- <code title="post /ai/missions/{mission_id}/runs/{run_id}/pause">client.ai.missions.runs.<a href="./src/telnyx/resources/ai/missions/runs/runs.py">pause_run</a>(run_id, \*, mission_id) -> <a href="./src/telnyx/types/ai/missions/mission_run_response.py">MissionRunResponse</a></code>
- <code title="post /ai/missions/{mission_id}/runs/{run_id}/resume">client.ai.missions.runs.<a href="./src/telnyx/resources/ai/missions/runs/runs.py">resume_run</a>(run_id, \*, mission_id) -> <a href="./src/telnyx/types/ai/missions/mission_run_response.py">MissionRunResponse</a></code>
...
```python
from telnyx.types.ai.missions.runs import EventData, EventResponse, EventType
```
...
- <code title="get /ai/missions/{mission_id}/runs/{run_id}/events/{event_id}">client.ai.missions.runs.events.<a href="./src/telnyx/resources/ai/missions/runs/events.py">get_event_details</a>(event_id, \*, mission_id, run_id) -> <a href="./src/telnyx/types/ai/missions/runs/event_response.py">EventResponse</a></code>
- <code title="post /ai/missions/{mission_id}/runs/{run_id}/events">client.ai.missions.runs.events.<a href="./src/telnyx/resources/ai/missions/runs/events.py">log</a>(run_id, \*, mission_id, \*\*<a href="src/telnyx/types/ai/missions/runs/event_log_params.py">params</a>) -> <a href="./src/telnyx/types/ai/missions/runs/event_response.py">EventResponse</a></code>
...
- <code title="post /ai/missions/{mission_id}/runs/{run_id}/plan">client.ai.missions.runs.plan.<a href="./src/telnyx/resources/ai/missions/runs/plan.py">create</a>(run_id, \*, mission_id, \*\*<a href="src/telnyx/types/ai/missions/runs/plan_create_params.py">params</a>) -> <a href="./src/telnyx/types/ai/missions/runs/plan_steps_created_response.py">PlanStepsCreatedResponse</a></code>
- <code title="get /ai/missions/{mission_id}/runs/{run_id}/plan">client.ai.missions.runs.plan.<a href="./src/telnyx/resources/ai/missions/runs/plan.py">retrieve</a>(run_id, \*, mission_id) -> <a href="./src/telnyx/types/ai/missions/runs/plan_retrieve_response.py">PlanRetrieveResponse</a></code>
- <code title="post /ai/missions/{mission_id}/runs/{run_id}/plan/steps">client.ai.missions.runs.plan.<a href="./src/telnyx/resources/ai/missions/runs/plan.py">add_steps_to_plan</a>(run_id, \*, mission_id, \*\*<a href="src/telnyx/types/ai/missions/runs/plan_add_steps_to_plan_params.py">params</a>) -> <a href="./src/telnyx/types/ai/missions/runs/plan_steps_created_response.py">PlanStepsCreatedResponse</a></code>
- <code title="get /ai/missions/{mission_id}/runs/{run_id}/plan/steps/{step_id}">client.ai.missions.runs.plan.<a href="./src/telnyx/resources/ai/missions/runs/plan.py">get_step_details</a>(step_id, \*, mission_id, run_id) -> <a href="./src/telnyx/types/ai/missions/runs/plan_step_response.py">PlanStepResponse</a></code>
- <code title="patch /ai/missions/{mission_id}/runs/{run_id}/plan/steps/{step_id}">client.ai.missions.runs.plan.<a href="./src/telnyx/resources/ai/missions/runs/plan.py">update_step</a>(step_id, \*, mission_id, run_id, \*\*<a href="src/telnyx/types/ai/missions/runs/plan_update_step_params.py">params</a>) -> <a href="./src/telnyx/types/ai/missions/runs/plan_step_response.py">PlanStepResponse</a></code>
...
- <code title="get /ai/missions/{mission_id}/runs/{run_id}/telnyx-agents">client.ai.missions.runs.telnyx_agents.<a href="./src/telnyx/resources/ai/missions/runs/telnyx_agents.py">list</a>(run_id, \*, mission_id) -> <a href="./src/telnyx/types/ai/missions/runs/telnyx_agent_list_response.py">TelnyxAgentListResponse</a></code>
- <code title="post /ai/missions/{mission_id}/runs/{run_id}/telnyx-agents">client.ai.missions.runs.telnyx_agents.<a href="./src/telnyx/resources/ai/missions/runs/telnyx_agents.py">link</a>(run_id, \*, mission_id, \*\*<a href="src/telnyx/types/ai/missions/runs/telnyx_agent_link_params.py">params</a>) -> <a href="./src/telnyx/types/ai/missions/runs/telnyx_agent_link_response.py">TelnyxAgentLinkResponse</a></code>
- <code title="delete /ai/missions/{mission_id}/runs/{run_id}/telnyx-agents/{telnyx_agent_id}">client.ai.missions.runs.telnyx_agents.<a href="./src/telnyx/resources/ai/missions/runs/telnyx_agents.py">unlink</a>(telnyx_agent_id, \*, mission_id, run_id) -> None</code>

### KnowledgeBases

Methods:

- <code title="post /ai/missions/{mission_id}/knowledge-bases">client.ai.missions.knowledge_bases.<a href="./src/telnyx/resources/ai/missions/knowledge_bases.py">create_knowledge_base</a>(mission_id) -> object</code>
- <code title="delete /ai/missions/{mission_id}/knowledge-bases/{knowledge_base_id}">client.ai.missions.knowledge_bases.<a href="./src/telnyx/resources/ai/missions/knowledge_bases.py">delete_knowledge_base</a>(knowledge_base_id, \*, mission_id) -> None</code>
- <code title="get /ai/missions/{mission_id}/knowledge-bases/{knowledge_base_id}">client.ai.missions.knowledge_bases.<a href="./src/telnyx/resources/ai/missions/knowledge_bases.py">get_knowledge_base</a>(knowledge_base_id, \*, mission_id) -> object</code>
- <code title="get /ai/missions/{mission_id}/knowledge-bases">client.ai.missions.knowledge_bases.<a href="./src/telnyx/resources/ai/missions/knowledge_bases.py">list_knowledge_bases</a>(mission_id) -> object</code>
- <code title="put /ai/missions/{mission_id}/knowledge-bases/{knowledge_base_id}">client.ai.missions.knowledge_bases.<a href="./src/telnyx/resources/ai/missions/knowledge_bases.py">update_knowledge_base</a>(knowledge_base_id, \*, mission_id) -> object</code>

### McpServers

Methods:

- <code title="post /ai/missions/{mission_id}/mcp-servers">client.ai.missions.mcp_servers.<a href="./src/telnyx/resources/ai/missions/mcp_servers.py">create_mcp_server</a>(mission_id) -> object</code>
- <code title="delete /ai/missions/{mission_id}/mcp-servers/{mcp_server_id}">client.ai.missions.mcp_servers.<a href="./src/telnyx/resources/ai/missions/mcp_servers.py">delete_mcp_server</a>(mcp_server_id, \*, mission_id) -> None</code>
- <code title="get /ai/missions/{mission_id}/mcp-servers/{mcp_server_id}">client.ai.missions.mcp_servers.<a href="./src/telnyx/resources/ai/missions/mcp_servers.py">get_mcp_server</a>(mcp_server_id, \*, mission_id) -> object</code>
- <code title="get /ai/missions/{mission_id}/mcp-servers">client.ai.missions.mcp_servers.<a href="./src/telnyx/resources/ai/missions/mcp_servers.py">list_mcp_servers</a>(mission_id) -> object</code>
- <code title="put /ai/missions/{mission_id}/mcp-servers/{mcp_server_id}">client.ai.missions.mcp_servers.<a href="./src/telnyx/resources/ai/missions/mcp_servers.py">update_mcp_server</a>(mcp_server_id, \*, mission_id) -> object</code>

### Tools

Methods:

- <code title="post /ai/missions/{mission_id}/tools">client.ai.missions.tools.<a href="./src/telnyx/resources/ai/missions/tools.py">create_tool</a>(mission_id) -> object</code>
- <code title="delete /ai/missions/{mission_id}/tools/{tool_id}">client.ai.missions.tools.<a href="./src/telnyx/resources/ai/missions/tools.py">delete_tool</a>(tool_id, \*, mission_id) -> None</code>
- <code title="get /ai/missions/{mission_id}/tools/{tool_id}">client.ai.missions.tools.<a href="./src/telnyx/resources/ai/missions/tools.py">get_tool</a>(tool_id, \*, mission_id) -> object</code>
- <code title="get /ai/missions/{mission_id}/tools">client.ai.missions.tools.<a href="./src/telnyx/resources/ai/missions/tools.py">list_tools</a>(mission_id) -> object</code>
- <code title="put /ai/missions/{mission_id}/tools/{tool_id}">client.ai.missions.tools.<a href="./src/telnyx/resources/ai/missions/tools.py">update_tool</a>(tool_id, \*, mission_id) -> object</code>
...
- <code title="get /ai/openai/models">client.ai.openai.<a href="./src/telnyx/resources/ai/openai/openai.py">list_models</a>() -> <a href="./src/telnyx/types/models_response.py">ModelsResponse</a></code>
...
- <code title="post /ai/tools">client.ai.tools.<a href="./src/telnyx/resources/ai/tools.py">create</a>(\*\*<a href="src/telnyx/types/ai/tool_create_params.py">params</a>) -> <a href="./src/telnyx/types/ai/shared_tool_response.py">SharedToolResponse</a></code>
...
- <code title="get /audit_events">client.audit_events.<a href="./src/telnyx/resources/audit_events.py">list</a>(\*\*<a href="src/telnyx/types/audit_event_list_params.py">params</a>) -> <a href="./src/telnyx/types/audit_event_list_response.py">SyncDefaultFlatPagination[AuditEventListResponse]</a></code>
...
- <code title="get /bulk_sim_card_actions">client.bulk_sim_card_actions.<a href="./src/telnyx/resources/bulk_sim_card_actions.py">list</a>(\*\*<a href="src/telnyx/types/bulk_sim_card_action_list_params.py">params</a>) -> <a href="./src/telnyx/types/bulk_sim_card_action_detailed.py">SyncDefaultFlatPagination[BulkSimCardActionDetailed]</a></code>
...
- <code title="post /calls/{call_control_id}/actions/conversation_relay_start">client.calls.actions.<a href="./src/telnyx/resources/calls/actions.py">start_conversation_relay</a>(call_control_id, \*\*<a href="src/telnyx/types/calls/action_start_conversation_relay_params.py">params</a>) -> <a href="./src/telnyx/types/calls/action_start_conversation_relay_response.py">ActionStartConversationRelayResponse</a></code>
...
- <code title="post /calls/{call_control_id}/actions/conversation_relay_stop">client.calls.actions.<a href="./src/telnyx/resources/calls/actions.py">stop_conversation_relay</a>(call_control_id, \*\*<a href="src/telnyx/types/calls/action_stop_conversation_relay_params.py">params</a>) -> <a href="./src/telnyx/types/calls/action_stop_conversation_relay_response.py">ActionStopConversationRelayResponse</a></code>
...
- <code title="put /channel_zones/{channel_zone_id}">client.channel_zones.<a href="./src/telnyx/resources/channel_zones.py">update</a>(channel_zone_id, \*\*<a href="src/telnyx/types/channel_zone_update_params.py">params</a>) -> <a href="./src/telnyx/types/gcb_channel_zone.py">GcbChannelZone</a></code>
- <code title="get /channel_zones">client.channel_zones.<a href="./src/telnyx/resources/channel_zones.py">list</a>(\*\*<a href="src/telnyx/types/channel_zone_list_params.py">params</a>) -> <a href="./src/telnyx/types/gcb_channel_zone.py">SyncDefaultFlatPagination[GcbChannelZone]</a></code>
...
- <code title="get /conferences/{id}/participants/{participant_id}">client.conferences.<a href="./src/telnyx/resources/conferences/conferences.py">retrieve_participant</a>(participant_id, \*, id) -> <a href="./src/telnyx/types/conference_participant_resource.py">ConferenceParticipantResource</a></code>
- <code title="patch /conferences/{id}/participants/{participant_id}">client.conferences.<a href="./src/telnyx/resources/conferences/conferences.py">update_participant</a>(participant_id, \*, id, \*\*<a href="src/telnyx/types/conference_update_participant_params.py">params</a>) -> <a href="./src/telnyx/types/conference_participant_resource.py">ConferenceParticipantResource</a></code>
...
- <code title="post /conferences/{id}/actions/end">client.conferences.actions.<a href="./src/telnyx/resources/conferences/actions.py">end_conference</a>(id, \*\*<a href="src/telnyx/types/conferences/action_end_conference_params.py">params</a>) -> <a href="./src/telnyx/types/conferences/action_end_conference_response.py">ActionEndConferenceResponse</a></code>
- <code title="post /conferences/{id}/actions/gather_using_audio">client.conferences.actions.<a href="./src/telnyx/resources/conferences/actions.py">gather_dtmf_audio</a>(id, \*\*<a href="src/telnyx/types/conferences/action_gather_dtmf_audio_params.py">params</a>) -> <a href="./src/telnyx/types/conferences/action_gather_dtmf_audio_response.py">ActionGatherDtmfAudioResponse</a></code>
...
- <code title="post /custom_storage_credentials/{connection_id}">client.custom_storage_credentials.<a href="./src/telnyx/resources/custom_storage_credentials.py">create</a>(connection_id, \*\*<a href="src/telnyx/types/custom_storage_credential_create_params.py">params</a>) -> <a href="./src/telnyx/types/credentials_response.py">CredentialsResponse</a></code>
- <code title="get /custom_storage_credentials/{connection_id}">client.custom_storage_credentials.<a href="./src/telnyx/resources/custom_storage_credentials.py">retrieve</a>(connection_id) -> <a href="./src/telnyx/types/credentials_response.py">CredentialsResponse</a></code>
- <code title="put /custom_storage_credentials/{connection_id}">client.custom_storage_credentials.<a href="./src/telnyx/resources/custom_storage_credentials.py">update</a>(connection_id, \*\*<a href="src/telnyx/types/custom_storage_credential_update_params.py">params</a>) -> <a href="./src/telnyx/types/credentials_response.py">CredentialsResponse</a></code>
...
- <code title="get /customer_service_records">client.customer_service_records.<a href="./src/telnyx/resources/customer_service_records.py">list</a>(\*\*<a href="src/telnyx/types/customer_service_record_list_params.py">params</a>) -> <a href="./src/telnyx/types/customer_service_record.py">SyncDefaultFlatPagination[CustomerServiceRecord]</a></code>
...
```python
from telnyx.types import DialogflowConnectionResponse
```

Methods:

- <code title="post /dialogflow_connections/{connection_id}">client.dialogflow_connections.<a href="./src/telnyx/resources/dialogflow_connections.py">create</a>(connection_id, \*\*<a href="src/telnyx/types/dialogflow_connection_create_params.py">params</a>) -> <a href="./src/telnyx/types/dialogflow_connection_response.py">DialogflowConnectionResponse</a></code>
- <code title="get /dialogflow_connections/{connection_id}">client.dialogflow_connections.<a href="./src/telnyx/resources/dialogflow_connections.py">retrieve</a>(connection_id) -> <a href="./src/telnyx/types/dialogflow_connection_response.py">DialogflowConnectionResponse</a></code>
- <code title="put /dialogflow_connections/{connection_id}">client.dialogflow_connections.<a href="./src/telnyx/resources/dialogflow_connections.py">update</a>(connection_id, \*\*<a href="src/telnyx/types/dialogflow_connection_update_params.py">params</a>) -> <a href="./src/telnyx/types/dialogflow_connection_response.py">DialogflowConnectionResponse</a></code>
...
- <code title="get /document_links">client.document_links.<a href="./src/telnyx/resources/document_links.py">list</a>(\*\*<a href="src/telnyx/types/document_link_list_params.py">params</a>) -> <a href="./src/telnyx/types/document_link_list_response.py">SyncDefaultFlatPagination[DocumentLinkListResponse]</a></code>
...
- <code title="get /documents">client.documents.<a href="./src/telnyx/resources/documents.py">list</a>(\*\*<a href="src/telnyx/types/document_list_params.py">params</a>) -> <a href="./src/telnyx/types/doc_service_document.py">SyncDefaultFlatPagination[DocServiceDocument]</a></code>
...
- <code title="get /dynamic_emergency_addresses">client.dynamic_emergency_addresses.<a href="./src/telnyx/resources/dynamic_emergency_addresses.py">list</a>(\*\*<a href="src/telnyx/types/dynamic_emergency_address_list_params.py">params</a>) -> <a href="./src/telnyx/types/dynamic_emergency_address.py">SyncDefaultFlatPagination[DynamicEmergencyAddress]</a></code>
...
- <code title="get /dynamic_emergency_endpoints">client.dynamic_emergency_endpoints.<a href="./src/telnyx/resources/dynamic_emergency_endpoints.py">list</a>(\*\*<a href="src/telnyx/types/dynamic_emergency_endpoint_list_params.py">params</a>) -> <a href="./src/telnyx/types/dynamic_emergency_endpoint.py">SyncDefaultFlatPagination[DynamicEmergencyEndpoint]</a></code>
...
- <code title="get /external_connections">client.external_connections.<a href="./src/telnyx/resources/external_connections/external_connections.py">list</a>(\*\*<a href="src/telnyx/types/external_connection_list_params.py">params</a>) -> <a href="./src/telnyx/types/external_connection.py">SyncDefaultFlatPagination[ExternalConnection]</a></code>
...
```python
from telnyx.types.external_connections import Release, TnReleaseEntry, ReleaseRetrieveResponse
```
...
- <code title="get /fax_applications">client.fax_applications.<a href="./src/telnyx/resources/fax_applications.py">list</a>(\*\*<a href="src/telnyx/types/fax_application_list_params.py">params</a>) -> <a href="./src/telnyx/types/fax_application.py">SyncDefaultFlatPagination[FaxApplication]</a></code>
...
```python
from telnyx.types import Fax, Quality, FaxCreateResponse, FaxRetrieveResponse
```
...
- <code title="get /fqdns">client.fqdns.<a href="./src/telnyx/resources/fqdns.py">list</a>(\*\*<a href="src/telnyx/types/fqdn_list_params.py">params</a>) -> <a href="./src/telnyx/types/fqdn.py">SyncDefaultFlatPagination[Fqdn]</a></code>
...
- <code title="get /global_ip_assignments">client.global_ip_assignments.<a href="./src/telnyx/resources/global_ip_assignments.py">list</a>(\*\*<a href="src/telnyx/types/global_ip_assignment_list_params.py">params</a>) -> <a href="./src/telnyx/types/global_ip_assignment.py">SyncDefaultFlatPagination[GlobalIPAssignment]</a></code>
...
- <code title="get /global_ip_health_checks">client.global_ip_health_checks.<a href="./src/telnyx/resources/global_ip_health_checks.py">list</a>(\*\*<a href="src/telnyx/types/global_ip_health_check_list_params.py">params</a>) -> <a href="./src/telnyx/types/global_ip_health_check.py">SyncDefaultFlatPagination[GlobalIPHealthCheck]</a></code>
...
- <code title="get /global_ips">client.global_ips.<a href="./src/telnyx/resources/global_ips.py">list</a>(\*\*<a href="src/telnyx/types/global_ip_list_params.py">params</a>) -> <a href="./src/telnyx/types/global_ip.py">SyncDefaultFlatPagination[GlobalIP]</a></code>
...
- <code title="get /ip_connections">client.ip_connections.<a href="./src/telnyx/resources/ip_connections.py">list</a>(\*\*<a href="src/telnyx/types/ip_connection_list_params.py">params</a>) -> <a href="./src/telnyx/types/ip_connection.py">SyncDefaultFlatPagination[IPConnection]</a></code>
...
- <code title="get /ips">client.ips.<a href="./src/telnyx/resources/ips.py">list</a>(\*\*<a href="src/telnyx/types/ip_list_params.py">params</a>) -> <a href="./src/telnyx/types/ip.py">SyncDefaultFlatPagination[IP]</a></code>
...
- <code title="get /messaging_hosted_number_orders">client.messaging_hosted_number_orders.<a href="./src/telnyx/resources/messaging_hosted_number_orders/messaging_hosted_number_orders.py">list</a>(\*\*<a href="src/telnyx/types/messaging_hosted_number_order_list_params.py">params</a>) -> <a href="./src/telnyx/types/shared/messaging_hosted_number_order.py">SyncDefaultFlatPagination[MessagingHostedNumberOrder]</a></code>
...
- <code title="get /messaging_optouts">client.messaging_optouts.<a href="./src/telnyx/resources/messaging_optouts.py">list</a>(\*\*<a href="src/telnyx/types/messaging_optout_list_params.py">params</a>) -> <a href="./src/telnyx/types/messaging_optout_list_response.py">SyncDefaultFlatPagination[MessagingOptoutListResponse]</a></code>
...
- <code title="get /messaging_url_domains">client.messaging_url_domains.<a href="./src/telnyx/resources/messaging_url_domains.py">list</a>(\*\*<a href="src/telnyx/types/messaging_url_domain_list_params.py">params</a>) -> <a href="./src/telnyx/types/messaging_url_domain_list_response.py">SyncDefaultFlatPagination[MessagingURLDomainListResponse]</a></code>
...
- <code title="get /mobile_network_operators">client.mobile_network_operators.<a href="./src/telnyx/resources/mobile_network_operators.py">list</a>(\*\*<a href="src/telnyx/types/mobile_network_operator_list_params.py">params</a>) -> <a href="./src/telnyx/types/mobile_network_operator_list_response.py">SyncDefaultFlatPagination[MobileNetworkOperatorListResponse]</a></code>
...
- <code title="get /mobile_push_credentials">client.mobile_push_credentials.<a href="./src/telnyx/resources/mobile_push_credentials.py">list</a>(\*\*<a href="src/telnyx/types/mobile_push_credential_list_params.py">params</a>) -> <a href="./src/telnyx/types/push_credential.py">SyncDefaultFlatPagination[PushCredential]</a></code>
...
- <code title="get /network_coverage">client.network_coverage.<a href="./src/telnyx/resources/network_coverage.py">list</a>(\*\*<a href="src/telnyx/types/network_coverage_list_params.py">params</a>) -> <a href="./src/telnyx/types/network_coverage_list_response.py">SyncDefaultFlatPagination[NetworkCoverageListResponse]</a></code>
...
- <code title="get /networks">client.networks.<a href="./src/telnyx/resources/networks/networks.py">list</a>(\*\*<a href="src/telnyx/types/network_list_params.py">params</a>) -> <a href="./src/telnyx/types/network.py">SyncDefaultFlatPagination[Network]</a></code>
...
- <code title="get /networks/{id}/network_interfaces">client.networks.<a href="./src/telnyx/resources/networks/networks.py">list_interfaces</a>(id, \*\*<a href="src/telnyx/types/network_list_interfaces_params.py">params</a>) -> <a href="./src/telnyx/types/network_list_interfaces_response.py">SyncDefaultFlatPagination[NetworkListInterfacesResponse]</a></code>
...
- <code title="get /notification_channels">client.notification_channels.<a href="./src/telnyx/resources/notification_channels.py">list</a>(\*\*<a href="src/telnyx/types/notification_channel_list_params.py">params</a>) -> <a href="./src/telnyx/types/notification_channel.py">SyncDefaultFlatPagination[NotificationChannel]</a></code>
...
- <code title="get /notification_event_conditions">client.notification_event_conditions.<a href="./src/telnyx/resources/notification_event_conditions.py">list</a>(\*\*<a href="src/telnyx/types/notification_event_condition_list_params.py">params</a>) -> <a href="./src/telnyx/types/notification_event_condition_list_response.py">SyncDefaultFlatPagination[NotificationEventConditionListResponse]</a></code>
...
- <code title="get /notification_profiles">client.notification_profiles.<a href="./src/telnyx/resources/notification_profiles.py">list</a>(\*\*<a href="src/telnyx/types/notification_profile_list_params.py">params</a>) -> <a href="./src/telnyx/types/notification_profile.py">SyncDefaultFlatPagination[NotificationProfile]</a></code>
...
- <code title="get /notification_settings">client.notification_settings.<a href="./src/telnyx/resources/notification_settings.py">list</a>(\*\*<a href="src/telnyx/types/notification_setting_list_params.py">params</a>) -> <a href="./src/telnyx/types/notification_setting.py">SyncDefaultFlatPagination[NotificationSetting]</a></code>
...
- <code title="get /number_block_orders">client.number_block_orders.<a href="./src/telnyx/resources/number_block_orders.py">list</a>(\*\*<a href="src/telnyx/types/number_block_order_list_params.py">params</a>) -> <a href="./src/telnyx/types/number_block_order.py">SyncDefaultFlatPagination[NumberBlockOrder]</a></code>
...
- <code title="get /number_orders">client.number_orders.<a href="./src/telnyx/resources/number_orders.py">list</a>(\*\*<a href="src/telnyx/types/number_order_list_params.py">params</a>) -> <a href="./src/telnyx/types/number_order_list_response.py">SyncDefaultFlatPagination[NumberOrderListResponse]</a></code>
...
- <code title="get /number_reservations">client.number_reservations.<a href="./src/telnyx/resources/number_reservations/number_reservations.py">list</a>(\*\*<a href="src/telnyx/types/number_reservation_list_params.py">params</a>) -> <a href="./src/telnyx/types/number_reservation.py">SyncDefaultFlatPagination[NumberReservation]</a></code>
...
- <code title="get /ota_updates">client.ota_updates.<a href="./src/telnyx/resources/ota_updates.py">list</a>(\*\*<a href="src/telnyx/types/ota_update_list_params.py">params</a>) -> <a href="./src/telnyx/types/ota_update_list_response.py">SyncDefaultFlatPagination[OtaUpdateListResponse]</a></code>
...
- <code title="get /phone_number_blocks/jobs">client.phone_number_blocks.jobs.<a href="./src/telnyx/resources/phone_number_blocks/jobs.py">list</a>(\*\*<a href="src/telnyx/types/phone_number_blocks/job_list_params.py">params</a>) -> <a href="./src/telnyx/types/phone_number_blocks/job.py">SyncDefaultFlatPagination[Job]</a></code>
...
- <code title="get /phone_numbers/csv_downloads">client.phone_numbers.csv_downloads.<a href="./src/telnyx/resources/phone_numbers/csv_downloads.py">list</a>(\*\*<a href="src/telnyx/types/phone_numbers/csv_download_list_params.py">params</a>) -> <a href="./src/telnyx/types/phone_numbers/csv_download.py">SyncDefaultFlatPagination[CsvDownload]</a></code>
...
- <code title="get /phone_numbers/jobs">client.phone_numbers.jobs.<a href="./src/telnyx/resources/phone_numbers/jobs.py">list</a>(\*\*<a href="src/telnyx/types/phone_numbers/job_list_params.py">params</a>) -> <a href="./src/telnyx/types/phone_numbers/phone_numbers_job.py">SyncDefaultFlatPagination[PhoneNumbersJob]</a></code>
...
- <code title="get /phone_numbers/voice">client.phone_numbers.voice.<a href="./src/telnyx/resources/phone_numbers/voice.py">list</a>(\*\*<a href="src/telnyx/types/phone_numbers/voice_list_params.py">params</a>) -> <a href="./src/telnyx/types/phone_numbers/phone_number_with_voice_settings.py">SyncDefaultFlatPagination[PhoneNumberWithVoiceSettings]</a></code>
...
- <code title="get /porting/events">client.porting.events.<a href="./src/telnyx/resources/porting/events.py">list</a>(\*\*<a href="src/telnyx/types/porting/event_list_params.py">params</a>) -> <a href="./src/telnyx/types/porting/porting_event.py">SyncDefaultFlatPagination[PortingEvent]</a></code>
...
- <code title="get /porting/reports">client.porting.reports.<a href="./src/telnyx/resources/porting/reports.py">list</a>(\*\*<a href="src/telnyx/types/porting/report_list_params.py">params</a>) -> <a href="./src/telnyx/types/porting/porting_report.py">SyncDefaultFlatPagination[PortingReport]</a></code>
...
- <code title="get /porting_orders">client.porting_orders.<a href="./src/telnyx/resources/porting_orders/porting_orders.py">list</a>(\*\*<a href="src/telnyx/types/porting_order_list_params.py">params</a>) -> <a href="./src/telnyx/types/porting_order.py">SyncDefaultFlatPagination[PortingOrder]</a></code>
...
- <code title="get /porting_orders/{id}/requirements">client.porting_orders.<a href="./src/telnyx/resources/porting_orders/porting_orders.py">retrieve_requirements</a>(id, \*\*<a href="src/telnyx/types/porting_order_retrieve_requirements_params.py">params</a>) -> <a href="./src/telnyx/types/porting_order_retrieve_requirements_response.py">SyncDefaultFlatPagination[PortingOrderRetrieveRequirementsResponse]</a></code>
...
- <code title="get /porting_orders/phone_number_configurations">client.porting_orders.phone_number_configurations.<a href="./src/telnyx/resources/porting_orders/phone_number_configurations.py">list</a>(\*\*<a href="src/telnyx/types/porting_orders/phone_number_configuration_list_params.py">params</a>) -> <a href="./src/telnyx/types/porting_orders/porting_phone_number_configuration.py">SyncDefaultFlatPagination[PortingPhoneNumberConfiguration]</a></code>
...
- <code title="get /porting_orders/{id}/activation_jobs">client.porting_orders.activation_jobs.<a href="./src/telnyx/resources/porting_orders/activation_jobs.py">list</a>(id, \*\*<a href="src/telnyx/types/porting_orders/activation_job_list_params.py">params</a>) -> <a href="./src/telnyx/types/porting_orders_activation_job.py">SyncDefaultFlatPagination[PortingOrdersActivationJob]</a></code>
...
```python
from telnyx.types.porting_orders import PortingAdditionalDocument, AdditionalDocumentCreateResponse
```
...
- <code title="get /porting_orders/{id}/additional_documents">client.porting_orders.additional_documents.<a href="./src/telnyx/resources/porting_orders/additional_documents.py">list</a>(id, \*\*<a href="src/telnyx/types/porting_orders/additional_document_list_params.py">params</a>) -> <a href="./src/telnyx/types/porting_orders/porting_additional_document.py">SyncDefaultFlatPagination[PortingAdditionalDocument]</a></code>
...
```python
from telnyx.types.porting_orders import PortingOrdersComment, CommentCreateResponse
```
...
```python
from telnyx.types.porting_orders import PortingActionRequirement, ActionRequirementInitiateResponse
```

Methods:

- <code title="get /porting_orders/{porting_order_id}/action_requirements">client.porting_orders.action_requirements.<a href="./src/telnyx/resources/porting_orders/action_requirements.py">list</a>(porting_order_id, \*\*<a href="src/telnyx/types/porting_orders/action_requirement_list_params.py">params</a>) -> <a href="./src/telnyx/types/porting_orders/porting_action_requirement.py">SyncDefaultFlatPagination[PortingActionRequirement]</a></code>
...
- <code title="get /porting_orders/{porting_order_id}/associated_phone_numbers">client.porting_orders.associated_phone_numbers.<a href="./src/telnyx/resources/porting_orders/associated_phone_numbers.py">list</a>(porting_order_id, \*\*<a href="src/telnyx/types/porting_orders/associated_phone_number_list_params.py">params</a>) -> <a href="./src/telnyx/types/porting_orders/porting_associated_phone_number.py">SyncDefaultFlatPagination[PortingAssociatedPhoneNumber]</a></code>
...
- <code title="get /porting_orders/{porting_order_id}/phone_number_blocks">client.porting_orders.phone_number_blocks.<a href="./src/telnyx/resources/porting_orders/phone_number_blocks.py">list</a>(porting_order_id, \*\*<a href="src/telnyx/types/porting_orders/phone_number_block_list_params.py">params</a>) -> <a href="./src/telnyx/types/porting_orders/porting_phone_number_block.py">SyncDefaultFlatPagination[PortingPhoneNumberBlock]</a></code>
...
```python
from telnyx.types import PortingOrderActivationStatus, PortingPhoneNumber
```

Methods:

- <code title="get /porting_phone_numbers">client.porting_phone_numbers.<a href="./src/telnyx/resources/porting_phone_numbers.py">list</a>(\*\*<a href="src/telnyx/types/porting_phone_number_list_params.py">params</a>) -> <a href="./src/telnyx/types/porting_phone_number.py">SyncDefaultFlatPagination[PortingPhoneNumber]</a></code>
...
- <code title="get /portouts">client.portouts.<a href="./src/telnyx/resources/portouts/portouts.py">list</a>(\*\*<a href="src/telnyx/types/portout_list_params.py">params</a>) -> <a href="./src/telnyx/types/portout_details.py">SyncDefaultFlatPagination[PortoutDetails]</a></code>
...
- <code title="get /portouts/events">client.portouts.events.<a href="./src/telnyx/resources/portouts/events.py">list</a>(\*\*<a href="src/telnyx/types/portouts/event_list_params.py">params</a>) -> <a href="./src/telnyx/types/portouts/portout_event.py">SyncDefaultFlatPagination[PortoutEvent]</a></code>
...
- <code title="get /portouts/reports">client.portouts.reports.<a href="./src/telnyx/resources/portouts/reports.py">list</a>(\*\*<a href="src/telnyx/types/portouts/report_list_params.py">params</a>) -> <a href="./src/telnyx/types/portouts/portout_report.py">SyncDefaultFlatPagination[PortoutReport]</a></code>
...
- <code title="get /recordings/{recording_id}">client.recordings.<a href="./src/telnyx/resources/recordings/recordings.py">retrieve</a>(recording_id) -> <a href="./src/telnyx/types/recording_response.py">RecordingResponse</a></code>
- <code title="get /recordings">client.recordings.<a href="./src/telnyx/resources/recordings/recordings.py">list</a>(\*\*<a href="src/telnyx/types/recording_list_params.py">params</a>) -> <a href="./src/telnyx/types/recording_response_data.py">SyncDefaultFlatPagination[RecordingResponseData]</a></code>
- <code title="delete /recordings/{recording_id}">client.recordings.<a href="./src/telnyx/resources/recordings/recordings.py">delete</a>(recording_id) -> <a href="./src/telnyx/types/recording_response.py">RecordingResponse</a></code>
...
- <code title="get /speech-to-text/transcription">client.speech_to_text.<a href="./src/telnyx/resources/speech_to_text.py">retrieve_transcription</a>(\*\*<a href="src/telnyx/types/speech_to_text_retrieve_transcription_params.py">params</a>) -> None</code>
...
- <code title="get /room_compositions">client.room_compositions.<a href="./src/telnyx/resources/room_compositions.py">list</a>(\*\*<a href="src/telnyx/types/room_composition_list_params.py">params</a>) -> <a href="./src/telnyx/types/room_composition.py">SyncDefaultFlatPagination[RoomComposition]</a></code>
...
- <code title="get /room_participants">client.room_participants.<a href="./src/telnyx/resources/room_participants.py">list</a>(\*\*<a href="src/telnyx/types/room_participant_list_params.py">params</a>) -> <a href="./src/telnyx/types/shared/room_participant.py">SyncDefaultFlatPagination[RoomParticipant]</a></code>
...
- <code title="get /room_recordings">client.room_recordings.<a href="./src/telnyx/resources/room_recordings.py">list</a>(\*\*<a href="src/telnyx/types/room_recording_list_params.py">params</a>) -> <a href="./src/telnyx/types/room_recording.py">SyncDefaultFlatPagination[RoomRecording]</a></code>
...
- <code title="get /rooms">client.rooms.<a href="./src/telnyx/resources/rooms/rooms.py">list</a>(\*\*<a href="src/telnyx/types/room_list_params.py">params</a>) -> <a href="./src/telnyx/types/room.py">SyncDefaultFlatPagination[Room]</a></code>
...
- <code title="get /room_sessions">client.rooms.sessions.<a href="./src/telnyx/resources/rooms/sessions/sessions.py">list_0</a>(\*\*<a href="src/telnyx/types/rooms/session_list_0_params.py">params</a>) -> <a href="./src/telnyx/types/room_session.py">SyncDefaultFlatPagination[RoomSession]</a></code>
- <code title="get /rooms/{room_id}/sessions">client.rooms.sessions.<a href="./src/telnyx/resources/rooms/sessions/sessions.py">list_1</a>(room_id, \*\*<a href="src/telnyx/types/rooms/session_list_1_params.py">params</a>) -> <a href="./src/telnyx/types/room_session.py">SyncDefaultFlatPagination[RoomSession]</a></code>
- <code title="get /room_sessions/{room_session_id}/participants">client.rooms.sessions.<a href="./src/telnyx/resources/rooms/sessions/sessions.py">retrieve_participants</a>(room_session_id, \*\*<a href="src/telnyx/types/rooms/session_retrieve_participants_params.py">params</a>) -> <a href="./src/telnyx/types/shared/room_participant.py">SyncDefaultFlatPagination[RoomParticipant]</a></code>
...
- <code title="get /short_codes">client.short_codes.<a href="./src/telnyx/resources/short_codes.py">list</a>(\*\*<a href="src/telnyx/types/short_code_list_params.py">params</a>) -> <a href="./src/telnyx/types/shared/short_code.py">SyncDefaultFlatPagination[ShortCode]</a></code>
...
- <code title="get /sim_card_orders">client.sim_card_orders.<a href="./src/telnyx/resources/sim_card_orders.py">list</a>(\*\*<a href="src/telnyx/types/sim_card_order_list_params.py">params</a>) -> <a href="./src/telnyx/types/sim_card_order.py">SyncDefaultFlatPagination[SimCardOrder]</a></code>
...
- <code title="get /sim_cards">client.sim_cards.<a href="./src/telnyx/resources/sim_cards/sim_cards.py">list</a>(\*\*<a href="src/telnyx/types/sim_card_list_params.py">params</a>) -> <a href="./src/telnyx/types/shared/simple_sim_card.py">SyncDefaultFlatPagination[SimpleSimCard]</a></code>
...
- <code title="post /siprec_connectors">client.siprec_connectors.<a href="./src/telnyx/resources/siprec_connectors.py">create</a>(\*\*<a href="src/telnyx/types/siprec_connector_create_params.py">params</a>) -> <a href="./src/telnyx/types/siprec_connector_response.py">SiprecConnectorResponse</a></code>
- <code title="get /siprec_connectors/{connector_name}">client.siprec_connectors.<a href="./src/telnyx/resources/siprec_connectors.py">retrieve</a>(connector_name) -> <a href="./src/telnyx/types/siprec_connector_response.py">SiprecConnectorResponse</a></code>
- <code title="put /siprec_connectors/{connector_name}">client.siprec_connectors.<a href="./src/telnyx/resources/siprec_connectors.py">update</a>(connector_name, \*\*<a href="src/telnyx/types/siprec_connector_update_params.py">params</a>) -> <a href="./src/telnyx/types/siprec_connector_response.py">SiprecConnectorResponse</a></code>
...
- <code title="post /storage/kvs">client.storage.kvs.<a href="./src/telnyx/resources/storage/kvs/kvs.py">create</a>(\*\*<a href="src/telnyx/types/storage/kv_create_params.py">params</a>) -> <a href="./src/telnyx/types/storage/kv_namespace_response_wrapper.py">KvNamespaceResponseWrapper</a></code>
- <code title="get /storage/kvs/{id}">client.storage.kvs.<a href="./src/telnyx/resources/storage/kvs/kvs.py">retrieve</a>(id) -> <a href="./src/telnyx/types/storage/kv_namespace_response_wrapper.py">KvNamespaceResponseWrapper</a></code>
- <code title="get /storage/kvs">client.storage.kvs.<a href="./src/telnyx/resources/storage/kvs/kvs.py">list</a>(\*\*<a href="src/telnyx/types/storage/kv_list_params.py">params</a>) -> <a href="./src/telnyx/types/storage/kv_namespace.py">SyncDefaultFlatPagination[KvNamespace]</a></code>
- <code title="delete /storage/kvs/{id}">client.storage.kvs.<a href="./src/telnyx/resources/storage/kvs/kvs.py">delete</a>(id) -> <a href="./src/telnyx/types/storage/kv_namespace_response_wrapper.py">KvNamespaceResponseWrapper</a></code>
...
- <code title="get /storage/cloudfs">client.storage.cloudfs.<a href="./src/telnyx/resources/storage/cloudfs/cloudfs.py">list</a>(\*\*<a href="src/telnyx/types/storage/cloudf_list_params.py">params</a>) -> <a href="./src/telnyx/types/storage/cloudf_list_response.py">SyncCloudfsCursorPagination[CloudfListResponse]</a></code>
...
- <code title="get /telephony_credentials">client.telephony_credentials.<a href="./src/telnyx/resources/telephony_credentials.py">list</a>(\*\*<a href="src/telnyx/types/telephony_credential_list_params.py">params</a>) -> <a href="./src/telnyx/types/telephony_credential.py">SyncDefaultFlatPagination[TelephonyCredential]</a></code>
...
- <code title="get /texml/Accounts/{account_sid}/Calls/{call_sid}">client.texml.accounts.calls.<a href="./src/telnyx/resources/texml/accounts/calls/calls.py">retrieve</a>(call_sid, \*, account_sid) -> <a href="./src/telnyx/types/texml/accounts/call_resource.py">CallResource</a></code>
- <code title="post /texml/Accounts/{account_sid}/Calls/{call_sid}">client.texml.accounts.calls.<a href="./src/telnyx/resources/texml/accounts/calls/calls.py">update</a>(call_sid, \*, account_sid, \*\*<a href="src/telnyx/types/texml/accounts/call_update_params.py">params</a>) -> <a href="./src/telnyx/types/texml/accounts/call_resource.py">CallResource</a></code>
...
- <code title="get /texml/Accounts/{account_sid}/Conferences/{conference_sid}">client.texml.accounts.conferences.<a href="./src/telnyx/resources/texml/accounts/conferences/conferences.py">retrieve</a>(conference_sid, \*, account_sid) -> <a href="./src/telnyx/types/texml/accounts/conference_resource.py">ConferenceResource</a></code>
- <code title="post /texml/Accounts/{account_sid}/Conferences/{conference_sid}">client.texml.accounts.conferences.<a href="./src/telnyx/resources/texml/accounts/conferences/conferences.py">update</a>(conference_sid, \*, account_sid, \*\*<a href="src/telnyx/types/texml/accounts/conference_update_params.py">params</a>) -> <a href="./src/telnyx/types/texml/accounts/conference_resource.py">ConferenceResource</a></code>
...
- <code title="get /texml/Accounts/{account_sid}/Conferences/{conference_sid}/Recordings.json">client.texml.accounts.conferences.<a href="./src/telnyx/resources/texml/accounts/conferences/conferences.py">retrieve_recordings_json</a>(conference_sid, \*, account_sid) -> <a href="./src/telnyx/types/texml/accounts/calls/texml_get_call_recordings_response_body.py">TexmlGetCallRecordingsResponseBody</a></code>
...
- <code title="post /texml/Accounts/{account_sid}/Queues">client.texml.accounts.queues.<a href="./src/telnyx/resources/texml/accounts/queues.py">create</a>(account_sid, \*\*<a href="src/telnyx/types/texml/accounts/queue_create_params.py">params</a>) -> <a href="./src/telnyx/types/texml/accounts/queue_resource.py">QueueResource</a></code>
- <code title="get /texml/Accounts/{account_sid}/Queues/{queue_sid}">client.texml.accounts.queues.<a href="./src/telnyx/resources/texml/accounts/queues.py">retrieve</a>(queue_sid, \*, account_sid) -> <a href="./src/telnyx/types/texml/accounts/queue_resource.py">QueueResource</a></code>
- <code title="post /texml/Accounts/{account_sid}/Queues/{queue_sid}">client.texml.accounts.queues.<a href="./src/telnyx/resources/texml/accounts/queues.py">update</a>(queue_sid, \*, account_sid, \*\*<a href="src/telnyx/types/texml/accounts/queue_update_params.py">params</a>) -> <a href="./src/telnyx/types/texml/accounts/queue_resource.py">QueueResource</a></code>
- <code title="get /texml/Accounts/{account_sid}/Queues">client.texml.accounts.queues.<a href="./src/telnyx/resources/texml/accounts/queues.py">list</a>(account_sid, \*\*<a href="src/telnyx/types/texml/accounts/queue_list_params.py">params</a>) -> <a href="./src/telnyx/types/texml/accounts/queue_resource.py">SyncDefaultPaginationForQueues[QueueResource]</a></code>
...
- <code title="get /texml_applications">client.texml_applications.<a href="./src/telnyx/resources/texml_applications.py">list</a>(\*\*<a href="src/telnyx/types/texml_application_list_params.py">params</a>) -> <a href="./src/telnyx/types/texml_application.py">SyncDefaultFlatPagination[TexmlApplication]</a></code>
...
- <code title="post /text-to-speech/speech">client.text_to_speech.<a href="./src/telnyx/resources/text_to_speech.py">generate_speech</a>(\*\*<a href="src/telnyx/types/text_to_speech_generate_speech_params.py">params</a>) -> <a href="./src/telnyx/types/text_to_speech_generate_speech_response.py">TextToSpeechGenerateSpeechResponse</a></code>
...
- <code title="get /text-to-speech/speech">client.text_to_speech.<a href="./src/telnyx/resources/text_to_speech.py">retrieve_speech</a>(\*\*<a href="src/telnyx/types/text_to_speech_retrieve_speech_params.py">params</a>) -> None</code>
...
```python
from telnyx.types import Attempt, HTTP, WebhookDelivery, WebhookDeliveryRetrieveResponse
```
...
- <code title="get /webhook_deliveries">client.webhook_deliveries.<a href="./src/telnyx/resources/webhook_deliveries.py">list</a>(\*\*<a href="src/telnyx/types/webhook_delivery_list_params.py">params</a>) -> <a href="./src/telnyx/types/webhook_delivery.py">SyncDefaultFlatPagination[WebhookDelivery]</a></code>
...
- <code title="get /wireguard_peers">client.wireguard_peers.<a href="./src/telnyx/resources/wireguard_peers.py">list</a>(\*\*<a href="src/telnyx/types/wireguard_peer_list_params.py">params</a>) -> <a href="./src/telnyx/types/wireguard_peer.py">SyncDefaultFlatPagination[WireguardPeer]</a></code>
...
- <code title="get /mobile_phone_numbers/messaging">client.mobile_phone_numbers.messaging.<a href="./src/telnyx/resources/mobile_phone_numbers/messaging.py">list</a>(\*\*<a href="src/telnyx/types/mobile_phone_numbers/messaging_list_params.py">params</a>) -> <a href="./src/telnyx/types/mobile_phone_numbers/mobile_phone_number_with_messaging_settings.py">SyncDefaultFlatPagination[MobilePhoneNumberWithMessagingSettings]</a></code>
...
- <code title="get /10dlc/brand/smsOtp/{referenceId}">client.messaging_10dlc.brand.<a href="./src/telnyx/resources/messaging_10dlc/brand/brand.py">get_sms_otp_by_reference</a>(reference_id, \*\*<a href="src/telnyx/types/messaging_10dlc/brand_get_sms_otp_by_reference_params.py">params</a>) -> <a href="./src/telnyx/types/messaging_10dlc/brand_sms_otp_status.py">BrandSMSOtpStatus</a></code>
...
- <code title="get /10dlc/brand/{brandId}/smsOtp">client.messaging_10dlc.brand.<a href="./src/telnyx/resources/messaging_10dlc/brand/brand.py">retrieve_sms_otp_status</a>(brand_id) -> <a href="./src/telnyx/types/messaging_10dlc/brand_sms_otp_status.py">BrandSMSOtpStatus</a></code>
...
```python
from telnyx.types.messaging_10dlc.brand import ExternalVetting, ExternalVettingListResponse
```
...
- <code title="put /10dlc/brand/{brandId}/externalVetting">client.messaging_10dlc.brand.external_vetting.<a href="./src/telnyx/resources/messaging_10dlc/brand/external_vetting.py">imports</a>(brand_id, \*\*<a href="src/telnyx/types/messaging_10dlc/brand/external_vetting_imports_params.py">params</a>) -> <a href="./src/telnyx/types/messaging_10dlc/brand/external_vetting.py">ExternalVetting</a></code>
- <code title="post /10dlc/brand/{brandId}/externalVetting">client.messaging_10dlc.brand.external_vetting.<a href="./src/telnyx/resources/messaging_10dlc/brand/external_vetting.py">order</a>(brand_id, \*\*<a href="src/telnyx/types/messaging_10dlc/brand/external_vetting_order_params.py">params</a>) -> <a href="./src/telnyx/types/messaging_10dlc/brand/external_vetting.py">ExternalVetting</a></code>
...
```python
from telnyx.types import MessagingMetricsTimeFrame, MessagingProfileMetricListResponse
```
...
- <code title="post /v2/x402/credit_account/quote">client.x402.credit_account.<a href="./src/telnyx/resources/x402/credit_account/credit_account.py">create_quote</a>(\*\*<a href="src/telnyx/types/x402/credit_account_create_quote_params.py">params</a>) -> <a href="./src/telnyx/types/x402/credit_account_create_quote_response.py">CreditAccountCreateQuoteResponse</a></code>
- <code title="post /v2/x402/credit_account">client.x402.credit_account.<a href="./src/telnyx/resources/x402/credit_account/credit_account.py">settle</a>(\*\*<a href="src/telnyx/types/x402/credit_account_settle_params.py">params</a>) -> <a href="./src/telnyx/types/x402/credit_account_settle_response.py">CreditAccountSettleResponse</a></code>
...
```python
from telnyx.types.x402.credit_account import X402TransactionRecord, PaymentRetrieveResponse
```

Methods:

- <code title="get /v2/x402/credit_account/payments/{id}">client.x402.credit_account.payments.<a href="./src/telnyx/resources/x402/credit_account/payments.py">retrieve</a>(id) -> <a href="./src/telnyx/types/x402/credit_account/payment_retrieve_response.py">PaymentRetrieveResponse</a></code>
- <code title="get /v2/x402/credit_account/payments">client.x402.credit_account.payments.<a href="./src/telnyx/resources/x402/credit_account/payments.py">list</a>(\*\*<a href="src/telnyx/types/x402/credit_account/payment_list_params.py">params</a>) -> <a href="./src/telnyx/types/x402/credit_account/x402_transaction_record.py">SyncDefaultFlatPagination[X402TransactionRecord]</a></code>
...
```python
from telnyx.types import VoiceCloneData, VoiceCloneResponse, VoiceDesignsPaginationMeta
```

Methods:

- <code title="post /voice_clones">client.voice_clones.<a href="./src/telnyx/resources/voice_clones.py">create</a>(\*\*<a href="src/telnyx/types/voice_clone_create_params.py">params</a>) -> <a href="./src/telnyx/types/voice_clone_response.py">VoiceCloneResponse</a></code>
- <code title="patch /voice_clones/{id}">client.voice_clones.<a href="./src/telnyx/resources/voice_clones.py">update</a>(id, \*\*<a href="src/telnyx/types/voice_clone_update_params.py">params</a>) -> <a href="./src/telnyx/types/voice_clone_response.py">VoiceCloneResponse</a></code>
...
- <code title="post /voice_clones/from_upload">client.voice_clones.<a href="./src/telnyx/resources/voice_clones.py">create_from_upload</a>(\*\*<a href="src/telnyx/types/voice_clone_create_from_upload_params.py">params</a>) -> <a href="./src/telnyx/types/voice_clone_response.py">VoiceCloneResponse</a></code>
...
- <code title="post /voice_designs">client.voice_designs.<a href="./src/telnyx/resources/voice_designs.py">create</a>(\*\*<a href="src/telnyx/types/voice_design_create_params.py">params</a>) -> <a href="./src/telnyx/types/voice_design_response.py">VoiceDesignResponse</a></code>
- <code title="get /voice_designs/{id}">client.voice_designs.<a href="./src/telnyx/resources/voice_designs.py">retrieve</a>(id, \*\*<a href="src/telnyx/types/voice_design_retrieve_params.py">params</a>) -> <a href="./src/telnyx/types/voice_design_response.py">VoiceDesignResponse</a></code>
- <code title="get /voice_designs">client.voice_designs.<a href="./src/telnyx/resources/voice_designs.py">list</a>(\*\*<a href="src/telnyx/types/voice_design_list_params.py">params</a>) -> <a href="./src/telnyx/types/voice_design_summary_data.py">SyncDefaultFlatPagination[VoiceDesignSummaryData]</a></code>
...
- <code title="post /enterprises">client.enterprises.<a href="./src/telnyx/resources/enterprises/enterprises.py">create</a>(\*\*<a href="src/telnyx/types/enterprise_create_params.py">params</a>) -> <a href="./src/telnyx/types/enterprise_public_wrapped.py">EnterprisePublicWrapped</a></code>
- <code title="get /enterprises/{enterprise_id}">client.enterprises.<a href="./src/telnyx/resources/enterprises/enterprises.py">retrieve</a>(enterprise_id) -> <a href="./src/telnyx/types/enterprise_public_wrapped.py">EnterprisePublicWrapped</a></code>
- <code title="put /enterprises/{enterprise_id}">client.enterprises.<a href="./src/telnyx/resources/enterprises/enterprises.py">update</a>(enterprise_id, \*\*<a href="src/telnyx/types/enterprise_update_params.py">params</a>) -> <a href="./src/telnyx/types/enterprise_public_wrapped.py">EnterprisePublicWrapped</a></code>
...
- <code title="post /enterprises/{enterprise_id}/branded_calling">client.enterprises.<a href="./src/telnyx/resources/enterprises/enterprises.py">branded_calling</a>(enterprise_id) -> <a href="./src/telnyx/types/enterprise_public_wrapped.py">EnterprisePublicWrapped</a></code>
...
- <code title="get /enterprises/{enterprise_id}/reputation">client.enterprises.reputation.<a href="./src/telnyx/resources/enterprises/reputation/reputation.py">retrieve</a>(enterprise_id) -> <a href="./src/telnyx/types/enterprises/enterprise_reputation_public_wrapped.py">EnterpriseReputationPublicWrapped</a></code>
...
- <code title="post /enterprises/{enterprise_id}/reputation/numbers/refresh">client.enterprises.reputation.numbers.<a href="./src/telnyx/resources/enterprises/reputation/numbers.py">refresh</a>(enterprise_id, \*\*<a href="src/telnyx/types/enterprises/reputation/number_refresh_params.py">params</a>) -> <a href="./src/telnyx/types/enterprises/reputation/number_refresh_response.py">NumberRefreshResponse</a></code>
...
```python
from telnyx.types.enterprises.reputation import AgentInput
```
...
- <code title="get /reputation/numbers/{phone_number}">client.reputation.numbers.<a href="./src/telnyx/resources/reputation/numbers.py">retrieve</a>(phone_number, \*\*<a href="src/telnyx/types/reputation/number_retrieve_params.py">params</a>) -> <a href="./src/telnyx/types/enterprises/reputation/reputation_phone_number_with_reputation.py">ReputationPhoneNumberWithReputation</a></code>
- <code title="get /reputation/numbers">client.reputation.numbers.<a href="./src/telnyx/resources/reputation/numbers.py">list</a>(\*\*<a href="src/telnyx/types/reputation/number_list_params.py">params</a>) -> <a href="./src/telnyx/types/enterprises/reputation/reputation_phone_number.py">SyncDefaultFlatPagination[ReputationPhoneNumber]</a></code>
...
```python
from telnyx.types import TermsOfServiceRetrieveInfoResponse, TermsOfServiceRetrieveStatusResponse
```
...
- <code title="get /terms_of_service/status">client.terms_of_service.<a href="./src/telnyx/resources/terms_of_service/terms_of_service.py">retrieve_status</a>(\*\*<a href="src/telnyx/types/terms_of_service_retrieve_status_params.py">params</a>) -> <a href="./src/telnyx/types/terms_of_service_retrieve_status_response.py">TermsOfServiceRetrieveStatusResponse</a></code>

## NumberReputation

Methods:

- <code title="post /terms_of_service/number_reputation/agree">client.terms_of_service.number_reputation.<a href="./src/telnyx/resources/terms_of_service/number_reputation.py">agree</a>() -> <a href="./src/telnyx/types/terms_of_service/tos_agreement_wrapped.py">TosAgreementWrapped</a></code>
...
```python
from telnyx.types.terms_of_service import TosAgreement, TosAgreementWrapped, TosProductType
```

Methods:

- <code title="get /terms_of_service/agreements/{agreement_id}">client.terms_of_service.agreements.<a href="./src/telnyx/resources/terms_of_service/agreements.py">retrieve</a>(agreement_id) -> <a href="./src/telnyx/types/terms_of_service/tos_agreement_wrapped.py">TosAgreementWrapped</a></code>
- <code title="get /terms_of_service/agreements">client.terms_of_service.agreements.<a href="./src/telnyx/resources/terms_of_service/agreements.py">list</a>(\*\*<a href="src/telnyx/types/terms_of_service/agreement_list_params.py">params</a>) -> <a href="./src/telnyx/types/terms_of_service/tos_agreement.py">SyncDefaultFlatPagination[TosAgreement]</a></code>

## BrandedCalling

Methods:

- <code title="post /terms_of_service/branded_calling/agree">client.terms_of_service.branded_calling.<a href="./src/telnyx/resources/terms_of_service/branded_calling.py">agree</a>() -> <a href="./src/telnyx/types/terms_of_service/tos_agreement_wrapped.py">TosAgreementWrapped</a></code>
...
- <code title="post /pronunciation_dicts">client.pronunciation_dicts.<a href="./src/telnyx/resources/pronunciation_dicts.py">create</a>(\*\*<a href="src/telnyx/types/pronunciation_dict_create_params.py">params</a>) -> <a href="./src/telnyx/types/pronunciation_dict_response.py">PronunciationDictResponse</a></code>
- <code title="get /pronunciation_dicts/{id}">client.pronunciation_dicts.<a href="./src/telnyx/resources/pronunciation_dicts.py">retrieve</a>(id) -> <a href="./src/telnyx/types/pronunciation_dict_response.py">PronunciationDictResponse</a></code>
- <code title="patch /pronunciation_dicts/{id}">client.pronunciation_dicts.<a href="./src/telnyx/resources/pronunciation_dicts.py">update</a>(id, \*\*<a href="src/telnyx/types/pronunciation_dict_update_params.py">params</a>) -> <a href="./src/telnyx/types/pronunciation_dict_response.py">PronunciationDictResponse</a></code>
...
- <code title="get /call_reasons">client.call_reasons.<a href="./src/telnyx/resources/call_reasons.py">list</a>(\*\*<a href="src/telnyx/types/call_reason_list_params.py">params</a>) -> <a href="./src/telnyx/types/call_reason_list_response.py">SyncDefaultFlatPagination[CallReasonListResponse]</a></code>
- <code title="post /call_reasons/validate">client.call_reasons.<a href="./src/telnyx/resources/call_reasons.py">validate</a>(\*\*<a href="src/telnyx/types/call_reason_validate_params.py">params</a>) -> <a href="./src/telnyx/types/call_reason_validate_response.py">CallReasonValidateResponse</a></code>
...
```python
from telnyx.types.dir import CommentType, DirComment, CommentCreateResponse
```

Methods:

- <code title="post /dir/{dir_id}/comments">client.dir.comments.<a href="./src/telnyx/resources/dir/comments.py">create</a>(dir_id, \*\*<a href="src/telnyx/types/dir/comment_create_params.py">params</a>) -> <a href="./src/telnyx/types/dir/comment_create_response.py">CommentCreateResponse</a></code>
- <code title="get /dir/{dir_id}/comments">client.dir.comments.<a href="./src/telnyx/resources/dir/comments.py">list</a>(dir_id, \*\*<a href="src/telnyx/types/dir/comment_list_params.py">params</a>) -> <a href="./src/telnyx/types/dir/dir_comment.py">SyncDefaultFlatPagination[DirComment]</a></code>
...
- <code title="get /dir/{dir_id}/phone_number_batches/{batch_id}">client.dir.phone_number_batches.<a href="./src/telnyx/resources/dir/phone_number_batches.py">retrieve</a>(batch_id, \*, dir_id) -> <a href="./src/telnyx/types/dir/phone_number_batch_retrieve_response.py">PhoneNumberBatchRetrieveResponse</a></code>
- <code title="get /dir/{dir_id}/phone_number_batches">client.dir.phone_number_batches.<a href="./src/telnyx/resources/dir/phone_number_batches.py">list</a>(dir_id, \*\*<a href="src/telnyx/types/dir/phone_number_batch_list_params.py">params</a>) -> <a href="./src/telnyx/types/dir/phone_number_batch.py">SyncDefaultFlatPagination[PhoneNumberBatch]</a></code>
...
```python
from telnyx.types import InfringementClaim, InfringementClaimWrapped
```

Methods:

- <code title="get /infringement_claims/{claim_id}">client.infringement_claims.<a href="./src/telnyx/resources/infringement_claims.py">retrieve</a>(claim_id) -> <a href="./src/telnyx/types/infringement_claim_wrapped.py">InfringementClaimWrapped</a></code>
- <code title="post /infringement_claims/{claim_id}/contest">client.infringement_claims.<a href="./src/telnyx/resources/infringement_claims.py">contest</a>(claim_id, \*\*<a href="src/telnyx/types/infringement_claim_contest_params.py">params</a>) -> <a href="./src/telnyx/types/infringement_claim_wrapped.py">InfringementClaimWrapped</a></code>
...
- <code title="post /email_blocks">client.email_blocks.<a href="./src/telnyx/resources/email_blocks/email_blocks.py">create</a>(\*\*<a href="src/telnyx/types/email_block_create_params.py">params</a>) -> <a href="./src/telnyx/types/email_block_response.py">EmailBlockResponse</a></code>
- <code title="get /email_blocks/{id}">client.email_blocks.<a href="./src/telnyx/resources/email_blocks/email_blocks.py">retrieve</a>(id) -> <a href="./src/telnyx/types/email_block_response.py">EmailBlockResponse</a></code>
- <code title="get /email_blocks">client.email_blocks.<a href="./src/telnyx/resources/email_blocks/email_blocks.py">list</a>(\*\*<a href="src/telnyx/types/email_block_list_params.py">params</a>) -> <a href="./src/telnyx/types/email_block.py">SyncDefaultFlatPagination[EmailBlock]</a></code>
- <code title="delete /email_blocks/{id}">client.email_blocks.<a href="./src/telnyx/resources/email_blocks/email_blocks.py">delete</a>(id) -> <a href="./src/telnyx/types/email_block_response.py">EmailBlockResponse</a></code>
...
- <code title="post /email_domains">client.email_domains.<a href="./src/telnyx/resources/email_domains/email_domains.py">create</a>(\*\*<a href="src/telnyx/types/email_domain_create_params.py">params</a>) -> <a href="./src/telnyx/types/email_domain_response.py">EmailDomainResponse</a></code>
- <code title="get /email_domains/{id}">client.email_domains.<a href="./src/telnyx/resources/email_domains/email_domains.py">retrieve</a>(id) -> <a href="./src/telnyx/types/email_domain_response.py">EmailDomainResponse</a></code>
- <code title="patch /email_domains/{id}">client.email_domains.<a href="./src/telnyx/resources/email_domains/email_domains.py">update</a>(id, \*\*<a href="src/telnyx/types/email_domain_update_params.py">params</a>) -> <a href="./src/telnyx/types/email_domain_response.py">EmailDomainResponse</a></code>
- <code title="get /email_domains">client.email_domains.<a href="./src/telnyx/resources/email_domains/email_domains.py">list</a>(\*\*<a href="src/telnyx/types/email_domain_list_params.py">params</a>) -> <a href="./src/telnyx/types/email_domain.py">SyncDefaultFlatPagination[EmailDomain]</a></code>
...
- <code title="post /email_domains/{domain_id}/webhooks">client.email_domains.webhooks.<a href="./src/telnyx/resources/email_domains/webhooks.py">create</a>(domain_id, \*\*<a href="src/telnyx/types/email_domains/webhook_create_params.py">params</a>) -> <a href="./src/telnyx/types/email_domains/email_webhook_response.py">EmailWebhookResponse</a></code>
- <code title="get /email_domains/{domain_id}/webhooks/{id}">client.email_domains.webhooks.<a href="./src/telnyx/resources/email_domains/webhooks.py">retrieve</a>(id, \*, domain_id) -> <a href="./src/telnyx/types/email_domains/email_webhook_response.py">EmailWebhookResponse</a></code>
- <code title="patch /email_domains/{domain_id}/webhooks/{id}">client.email_domains.webhooks.<a href="./src/telnyx/resources/email_domains/webhooks.py">update</a>(id, \*, domain_id, \*\*<a href="src/telnyx/types/email_domains/webhook_update_params.py">params</a>) -> <a href="./src/telnyx/types/email_domains/email_webhook_response.py">EmailWebhookResponse</a></code>
- <code title="get /email_domains/{domain_id}/webhooks">client.email_domains.webhooks.<a href="./src/telnyx/resources/email_domains/webhooks.py">list</a>(domain_id, \*\*<a href="src/telnyx/types/email_domains/webhook_list_params.py">params</a>) -> <a href="./src/telnyx/types/email_domains/email_webhook.py">SyncDefaultFlatPagination[EmailWebhook]</a></code>
- <code title="delete /email_domains/{domain_id}/webhooks/{id}">client.email_domains.webhooks.<a href="./src/telnyx/resources/email_domains/webhooks.py">delete</a>(id, \*, domain_id) -> <a href="./src/telnyx/types/email_domains/email_webhook_response.py">EmailWebhookResponse</a></code>
...
- <code title="post /email_inboxes">client.email_inboxes.<a href="./src/telnyx/resources/email_inboxes/email_inboxes.py">create</a>(\*\*<a href="src/telnyx/types/email_inbox_create_params.py">params</a>) -> <a href="./src/telnyx/types/email_inbox_response.py">EmailInboxResponse</a></code>
- <code title="get /email_inboxes/{id}">client.email_inboxes.<a href="./src/telnyx/resources/email_inboxes/email_inboxes.py">retrieve</a>(id) -> <a href="./src/telnyx/types/email_inbox_response.py">EmailInboxResponse</a></code>
- <code title="get /email_inboxes">client.email_inboxes.<a href="./src/telnyx/resources/email_inboxes/email_inboxes.py">list</a>(\*\*<a href="src/telnyx/types/email_inbox_list_params.py">params</a>) -> <a href="./src/telnyx/types/email_inbox.py">SyncEmailCursorPagination[EmailInbox]</a></code>
- <code title="delete /email_inboxes/{id}">client.email_inboxes.<a href="./src/telnyx/resources/email_inboxes/email_inboxes.py">delete</a>(id) -> None</code>
...
- <code title="get /email_inboxes/{inbox_id}/drafts">client.email_inboxes.drafts.<a href="./src/telnyx/resources/email_inboxes/drafts.py">list</a>(inbox_id, \*\*<a href="src/telnyx/types/email_inboxes/draft_list_params.py">params</a>) -> <a href="./src/telnyx/types/email_inboxes/email_draft.py">SyncEmailBracketCursorPagination[EmailDraft]</a></code>
...
```python
from telnyx.types.email_inboxes import MessageUpdateResponse
```

Methods:

- <code title="patch /email_inboxes/{inbox_id}/messages/{message_id}">client.email_inboxes.messages.<a href="./src/telnyx/resources/email_inboxes/messages/messages.py">update</a>(message_id, \*, inbox_id, \*\*<a href="src/telnyx/types/email_inboxes/message_update_params.py">params</a>) -> <a href="./src/telnyx/types/email_inboxes/message_update_response.py">MessageUpdateResponse</a></code>
- <code title="get /email_inboxes/{inbox_id}/messages">client.email_inboxes.messages.<a href="./src/telnyx/resources/email_inboxes/messages/messages.py">list</a>(inbox_id, \*\*<a href="src/telnyx/types/email_inboxes/message_list_params.py">params</a>) -> <a href="./src/telnyx/types/inbound_message.py">SyncEmailBracketCursorPagination[InboundMessage]</a></code>
- <code title="post /email_inboxes/{inbox_id}/messages/{message_id}/drafts">client.email_inboxes.messages.<a href="./src/telnyx/resources/email_inboxes/messages/messages.py">drafts</a>(message_id, \*, inbox_id, \*\*<a href="src/telnyx/types/email_inboxes/message_drafts_params.py">params</a>) -> <a href="./src/telnyx/types/email_inboxes/email_draft_response.py">EmailDraftResponse</a></code>
...
- <code title="post /email_inboxes/{inbox_id}/messages/{message_id}/actions/forward">client.email_inboxes.messages.actions.<a href="./src/telnyx/resources/email_inboxes/messages/actions.py">forward</a>(message_id, \*, inbox_id, \*\*<a href="src/telnyx/types/email_inboxes/messages/action_forward_params.py">params</a>) -> <a href="./src/telnyx/types/email_inboxes/email_message_response.py">EmailMessageResponse</a></code>
- <code title="post /email_inboxes/{inbox_id}/messages/{message_id}/actions/reply">client.email_inboxes.messages.actions.<a href="./src/telnyx/resources/email_inboxes/messages/actions.py">reply</a>(message_id, \*, inbox_id, \*\*<a href="src/telnyx/types/email_inboxes/messages/action_reply_params.py">params</a>) -> <a href="./src/telnyx/types/email_inboxes/email_message_response.py">EmailMessageResponse</a></code>
- <code title="post /email_inboxes/{inbox_id}/messages/{message_id}/actions/reply_all">client.email_inboxes.messages.actions.<a href="./src/telnyx/resources/email_inboxes/messages/actions.py">reply_all</a>(message_id, \*, inbox_id, \*\*<a href="src/telnyx/types/email_inboxes/messages/action_reply_all_params.py">params</a>) -> <a href="./src/telnyx/types/email_inboxes/email_message_response.py">EmailMessageResponse</a></code>
...
- <code title="post /email_inboxes/{inbox_id}/messages/{message_id}/labels">client.email_inboxes.messages.labels.<a href="./src/telnyx/resources/email_inboxes/messages/labels.py">create</a>(message_id, \*, inbox_id, \*\*<a href="src/telnyx/types/email_inboxes/messages/label_create_params.py">params</a>) -> <a href="./src/telnyx/types/email_inboxes/messages/label_create_response.py">LabelCreateResponse</a></code>
- <code title="delete /email_inboxes/{inbox_id}/messages/{message_id}/labels">client.email_inboxes.messages.labels.<a href="./src/telnyx/resources/email_inboxes/messages/labels.py">delete_all</a>(message_id, \*, inbox_id, \*\*<a href="src/telnyx/types/email_inboxes/messages/label_delete_all_params.py">params</a>) -> <a href="./src/telnyx/types/email_inboxes/messages/label_delete_all_response.py">LabelDeleteAllResponse</a></code>
...
- <code title="get /email_inboxes/{inbox_id}/threads/{thread_id}">client.email_inboxes.threads.<a href="./src/telnyx/resources/email_inboxes/threads/threads.py">retrieve</a>(thread_id, \*, inbox_id, \*\*<a href="src/telnyx/types/email_inboxes/thread_retrieve_params.py">params</a>) -> <a href="./src/telnyx/types/email_inboxes/thread_retrieve_response.py">ThreadRetrieveResponse</a></code>
- <code title="get /email_inboxes/{inbox_id}/threads">client.email_inboxes.threads.<a href="./src/telnyx/resources/email_inboxes/threads/threads.py">list</a>(inbox_id, \*\*<a href="src/telnyx/types/email_inboxes/thread_list_params.py">params</a>) -> <a href="./src/telnyx/types/email_inboxes/inbound_thread.py">SyncEmailBracketCursorPagination[InboundThread]</a></code>
...
```python
from telnyx.types.email_inboxes.threads import LabelCreateResponse, LabelDeleteAllResponse
```

Methods:

- <code title="post /email_inboxes/{inbox_id}/threads/{thread_id}/labels">client.email_inboxes.threads.labels.<a href="./src/telnyx/resources/email_inboxes/threads/labels.py">create</a>(thread_id, \*, inbox_id, \*\*<a href="src/telnyx/types/email_inboxes/threads/label_create_params.py">params</a>) -> <a href="./src/telnyx/types/email_inboxes/threads/label_create_response.py">LabelCreateResponse</a></code>
- <code title="delete /email_inboxes/{inbox_id}/threads/{thread_id}/labels">client.email_inboxes.threads.labels.<a href="./src/telnyx/resources/email_inboxes/threads/labels.py">delete_all</a>(thread_id, \*, inbox_id, \*\*<a href="src/telnyx/types/email_inboxes/threads/label_delete_all_params.py">params</a>) -> <a href="./src/telnyx/types/email_inboxes/threads/label_delete_all_response.py">LabelDeleteAllResponse</a></code>
...
```python
from telnyx.types.email_messages import EmailRecipient, RecipientRetrieveResponse
```

Methods:

- <code title="get /email_messages/{email_id}/recipients/{recipient_id}">client.email_messages.recipients.<a href="./src/telnyx/resources/email_messages/recipients.py">retrieve</a>(recipient_id, \*, email_id) -> <a href="./src/telnyx/types/email_messages/recipient_retrieve_response.py">RecipientRetrieveResponse</a></code>
- <code title="get /email_messages/{email_id}/recipients">client.email_messages.recipients.<a href="./src/telnyx/resources/email_messages/recipients.py">list</a>(email_id, \*\*<a href="src/telnyx/types/email_messages/recipient_list_params.py">params</a>) -> <a href="./src/telnyx/types/email_messages/email_recipient.py">SyncEmailCursorPagination[EmailRecipient]</a></code>
...
- <code title="post /email_templates">client.email_templates.<a href="./src/telnyx/resources/email_templates.py">create</a>(\*\*<a href="src/telnyx/types/email_template_create_params.py">params</a>) -> <a href="./src/telnyx/types/email_template_response.py">EmailTemplateResponse</a></code>
- <code title="get /email_templates/{id}">client.email_templates.<a href="./src/telnyx/resources/email_templates.py">retrieve</a>(id) -> <a href="./src/telnyx/types/email_template_response.py">EmailTemplateResponse</a></code>
- <code title="patch /email_templates/{id}">client.email_templates.<a href="./src/telnyx/resources/email_templates.py">update</a>(id, \*\*<a href="src/telnyx/types/email_template_update_params.py">params</a>) -> <a href="./src/telnyx/types/email_template_response.py">EmailTemplateResponse</a></code>
- <code title="get /email_templates">client.email_templates.<a href="./src/telnyx/resources/email_templates.py">list</a>(\*\*<a href="src/telnyx/types/email_template_list_params.py">params</a>) -> <a href="./src/telnyx/types/email_template.py">SyncEmailCursorPagination[EmailTemplate]</a></code>
...
- <code title="get /email_threads/{thread_id}">client.email_threads.<a href="./src/telnyx/resources/email_threads.py">retrieve</a>(thread_id, \*\*<a href="src/telnyx/types/email_thread_retrieve_params.py">params</a>) -> <a href="./src/telnyx/types/email_thread_retrieve_response.py">EmailThreadRetrieveResponse</a></code>
- <code title="get /email_threads">client.email_threads.<a href="./src/telnyx/resources/email_threads.py">list</a>(\*\*<a href="src/telnyx/types/email_thread_list_params.py">params</a>) -> <a href="./src/telnyx/types/email_inboxes/inbound_thread.py">SyncEmailBracketCursorPagination[InboundThread]</a></code>
...
```python
from telnyx.types import GroupListMeta, UnsubscribeGroup, UnsubscribeGroupResponse
```

Methods:

- <code title="post /email_unsubscribe_groups">client.email_unsubscribe_groups.<a href="./src/telnyx/resources/email_unsubscribe_groups/email_unsubscribe_groups.py">create</a>(\*\*<a href="src/telnyx/types/email_unsubscribe_group_create_params.py">params</a>) -> <a href="./src/telnyx/types/unsubscribe_group_response.py">UnsubscribeGroupResponse</a></code>
- <code title="get /email_unsubscribe_groups/{id}">client.email_unsubscribe_groups.<a href="./src/telnyx/resources/email_unsubscribe_groups/email_unsubscribe_groups.py">retrieve</a>(id) -> <a href="./src/telnyx/types/unsubscribe_group_response.py">UnsubscribeGroupResponse</a></code>
- <code title="patch /email_unsubscribe_groups/{id}">client.email_unsubscribe_groups.<a href="./src/telnyx/resources/email_unsubscribe_groups/email_unsubscribe_groups.py">update</a>(id, \*\*<a href="src/telnyx/types/email_unsubscribe_group_update_params.py">params</a>) -> <a href="./src/telnyx/types/unsubscribe_group_response.py">UnsubscribeGroupResponse</a></code>
- <code title="get /email_unsubscribe_groups">client.email_unsubscribe_groups.<a href="./src/telnyx/resources/email_unsubscribe_groups/email_unsubscribe_groups.py">list</a>(\*\*<a href="src/telnyx/types/email_unsubscribe_group_list_params.py">params</a>) -> <a href="./src/telnyx/types/unsubscribe_group.py">SyncDefaultFlatPagination[UnsubscribeGroup]</a></code>
- <code title="delete /email_unsubscribe_groups/{id}">client.email_unsubscribe_groups.<a href="./src/telnyx/resources/email_unsubscribe_groups/email_unsubscribe_groups.py">delete</a>(id, \*\*<a href="src/telnyx/types/email_unsubscribe_group_delete_params.py">params</a>) -> None</code>

## Suppressions

Methods:

- <code title="post /email_unsubscribe_groups/{id}/suppressions">client.email_unsubscribe_groups.suppressions.<a href="./src/telnyx/resources/email_unsubscribe_groups/suppressions.py">create</a>(id, \*\*<a href="src/telnyx/types/email_unsubscribe_groups/suppression_create_params.py">params</a>) -> <a href="./src/telnyx/types/email_block_response.py">EmailBlockResponse</a></code>
- <code title="get /email_unsubscribe_groups/{id}/suppressions">client.email_unsubscribe_groups.suppressions.<a href="./src/telnyx/resources/email_unsubscribe_groups/suppressions.py">list</a>(id, \*\*<a href="src/telnyx/types/email_unsubscribe_groups/suppression_list_params.py">params</a>) -> <a href="./src/telnyx/types/email_block.py">SyncDefaultFlatPagination[EmailBlock]</a></code>
- <code title="delete /email_unsubscribe_groups/{id}/suppressions/{email}">client.email_unsubscribe_groups.suppressions.<a href="./src/telnyx/resources/email_unsubscribe_groups/suppressions.py">delete</a>(email, \*, id) -> None</code>
...
- <code title="post /email_validations">client.email_validations.<a href="./src/telnyx/resources/email_validations/email_validations.py">create</a>(\*\*<a href="src/telnyx/types/email_validation_create_params.py">params</a>) -> <a href="./src/telnyx/types/email_validation_create_response.py">EmailValidationCreateResponse</a></code>
...
```python
from telnyx.types.email_validations import (
...
- <code title="get /pricing/products/{slug}">client.pricing.products.<a href="./src/telnyx/resources/pricing/products.py">retrieve</a>(slug, \*\*<a href="src/telnyx/types/pricing/product_retrieve_params.py">params</a>) -> <a href="./src/telnyx/types/pricing/product_retrieve_response.py">SyncDefaultFlatPagination[ProductRetrieveResponse]</a></code>
