...
@nested_resource_class_methods(  # noqa: E302
...
class TestVerification(unittest.TestCase):
    ...
    def test_verification_by_id(self, mock_request):
        mock_response = {"data": {"id": "verification_id", "status": "verified"}}
        ...
        mock_request.assert_called_with("post", "/v2/verifications/{}/actions/verify".format(verification_id), params)
