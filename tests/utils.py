...
from telnyx._types import Omit, NoneType
from telnyx._utils import (
    is_dict,
    is_list,
    is_list_type,
    is_union_type,
...
from telnyx._compat import PYDANTIC_V2, field_outer_type, get_model_fields
from telnyx._models import BaseModel
