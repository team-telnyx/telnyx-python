...
class TestOsr:
    ...
    def test_method_get_attributes(self, client: Telnyx) -> None:
        osr = client.messaging_10dlc.campaign.osr.get_attributes(
            "campaignId",
        )
    ...
    def test_raw_response_get_attributes(self, client: Telnyx) -> None:
        response = client.messaging_10dlc.campaign.osr.with_raw_response.get_attributes(
            "campaignId",
        )
    ...
    def test_streaming_response_get_attributes(self, client: Telnyx) -> None:
        with client.messaging_10dlc.campaign.osr.with_streaming_response.get_attributes(
            "campaignId",
        ) as response:
    ...
    def test_path_params_get_attributes(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `campaign_id` but received ''"):
            client.messaging_10dlc.campaign.osr.with_raw_response.get_attributes(
                "",
            )
...
class TestAsyncOsr:
    ...
    async def test_method_get_attributes(self, async_client: AsyncTelnyx) -> None:
        osr = await async_client.messaging_10dlc.campaign.osr.get_attributes(
            "campaignId",
        )
        assert_matches_type(OsrGetAttributesResponse, osr, path=["response"])
    ...
    async def test_raw_response_get_attributes(self, async_client: AsyncTelnyx) -> None:
        response = await async_client.messaging_10dlc.campaign.osr.with_raw_response.get_attributes(
            "campaignId",
        )
    ...
    async def test_streaming_response_get_attributes(self, async_client: AsyncTelnyx) -> None:
        async with async_client.messaging_10dlc.campaign.osr.with_streaming_response.get_attributes(
            "campaignId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get_attributes(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `campaign_id` but received ''"):
            await async_client.messaging_10dlc.campaign.osr.with_raw_response.get_attributes(
                "",
            )
