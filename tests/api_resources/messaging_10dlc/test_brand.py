...
class TestBrand:
    ...
    def test_path_params_retrieve(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            client.messaging_10dlc.brand.with_raw_response.retrieve(
                "",
            )
    ...
    def test_path_params_update(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            client.messaging_10dlc.brand.with_raw_response.update(
                brand_id="",
                country="US",
                display_name="ABC Mobile",
                email="email",
    ...
    def test_path_params_delete(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            client.messaging_10dlc.brand.with_raw_response.delete(
                "",
            )
    ...
    def test_path_params_get_feedback(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            client.messaging_10dlc.brand.with_raw_response.get_feedback(
                "",
            )
    ...
    def test_path_params_get_sms_otp_by_reference(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `reference_id` but received ''"):
            client.messaging_10dlc.brand.with_raw_response.get_sms_otp_by_reference(
                reference_id="",
            )
    ...
    def test_path_params_resend_2fa_email(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            client.messaging_10dlc.brand.with_raw_response.resend_2fa_email(
                "",
            )
    ...
    def test_path_params_revet(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            client.messaging_10dlc.brand.with_raw_response.revet(
                "",
            )
    ...
    def test_path_params_trigger_sms_otp(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            client.messaging_10dlc.brand.with_raw_response.trigger_sms_otp(
                brand_id="",
                pin_sms="Your PIN is @OTP_PIN@",
                success_sms="Verification successful!",
            )
    ...
    def test_path_params_verify_sms_otp(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            client.messaging_10dlc.brand.with_raw_response.verify_sms_otp(
                brand_id="",
                otp_pin="123456",
            )
...
class TestAsyncBrand:
    ...
    async def test_path_params_retrieve(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            await async_client.messaging_10dlc.brand.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_path_params_update(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            await async_client.messaging_10dlc.brand.with_raw_response.update(
                brand_id="",
                country="US",
                display_name="ABC Mobile",
                email="email",
    ...
    async def test_path_params_delete(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            await async_client.messaging_10dlc.brand.with_raw_response.delete(
                "",
            )
    ...
    async def test_path_params_get_feedback(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            await async_client.messaging_10dlc.brand.with_raw_response.get_feedback(
                "",
            )
    ...
    async def test_path_params_get_sms_otp_by_reference(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `reference_id` but received ''"):
            await async_client.messaging_10dlc.brand.with_raw_response.get_sms_otp_by_reference(
                reference_id="",
            )
    ...
    async def test_path_params_resend_2fa_email(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            await async_client.messaging_10dlc.brand.with_raw_response.resend_2fa_email(
                "",
            )
    ...
    async def test_path_params_revet(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            await async_client.messaging_10dlc.brand.with_raw_response.revet(
                "",
            )
    ...
    async def test_path_params_trigger_sms_otp(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            await async_client.messaging_10dlc.brand.with_raw_response.trigger_sms_otp(
                brand_id="",
                pin_sms="Your PIN is @OTP_PIN@",
                success_sms="Verification successful!",
            )
    ...
    async def test_path_params_verify_sms_otp(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            await async_client.messaging_10dlc.brand.with_raw_response.verify_sms_otp(
                brand_id="",
                otp_pin="123456",
            )
