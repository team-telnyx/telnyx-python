...
class TestPhoneNumberAssignmentByProfile:
    ...
    def test_path_params_list_phone_number_status(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `task_id` but received ''"):
            client.messaging_10dlc.phone_number_assignment_by_profile.with_raw_response.list_phone_number_status(
                task_id="",
            )
    ...
    def test_method_retrieve_phone_number_status(self, client: Telnyx) -> None:
        phone_number_assignment_by_profile = (
            client.messaging_10dlc.phone_number_assignment_by_profile.retrieve_phone_number_status(
                task_id="taskId",
            )
        )
        assert_matches_type(
    ...
    def test_raw_response_retrieve_phone_number_status(self, client: Telnyx) -> None:
        response = (
            client.messaging_10dlc.phone_number_assignment_by_profile.with_raw_response.retrieve_phone_number_status(
                task_id="taskId",
            )
        )
    ...
    def test_path_params_retrieve_status(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `task_id` but received ''"):
            client.messaging_10dlc.phone_number_assignment_by_profile.with_raw_response.retrieve_status(
                "",
            )
...
class TestAsyncPhoneNumberAssignmentByProfile:
    ...
    async def test_method_assign(self, async_client: AsyncTelnyx) -> None:
        phone_number_assignment_by_profile = (
            await async_client.messaging_10dlc.phone_number_assignment_by_profile.assign(
                messaging_profile_id="4001767e-ce0f-4cae-9d5f-0d5e636e7809",
            )
        )
        assert_matches_type(
    ...
    async def test_method_list_phone_number_status(self, async_client: AsyncTelnyx) -> None:
        phone_number_assignment_by_profile = (
            await async_client.messaging_10dlc.phone_number_assignment_by_profile.list_phone_number_status(
                task_id="taskId",
            )
        )
        assert_matches_type(
    ...
    async def test_path_params_list_phone_number_status(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `task_id` but received ''"):
            await async_client.messaging_10dlc.phone_number_assignment_by_profile.with_raw_response.list_phone_number_status(
                task_id="",
            )
    ...
    async def test_method_retrieve_phone_number_status(self, async_client: AsyncTelnyx) -> None:
        phone_number_assignment_by_profile = (
            await async_client.messaging_10dlc.phone_number_assignment_by_profile.retrieve_phone_number_status(
                task_id="taskId",
            )
        )
        assert_matches_type(
    ...
    async def test_path_params_retrieve_phone_number_status(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `task_id` but received ''"):
            await async_client.messaging_10dlc.phone_number_assignment_by_profile.with_raw_response.retrieve_phone_number_status(
                task_id="",
            )
    ...
    async def test_method_retrieve_status(self, async_client: AsyncTelnyx) -> None:
        phone_number_assignment_by_profile = (
            await async_client.messaging_10dlc.phone_number_assignment_by_profile.retrieve_status(
                "taskId",
            )
        )
        assert_matches_type(
    ...
    async def test_raw_response_retrieve_status(self, async_client: AsyncTelnyx) -> None:
        response = (
            await async_client.messaging_10dlc.phone_number_assignment_by_profile.with_raw_response.retrieve_status(
                "taskId",
            )
        )
    ...
    async def test_streaming_response_retrieve_status(self, async_client: AsyncTelnyx) -> None:
        async with (
            async_client.messaging_10dlc.phone_number_assignment_by_profile.with_streaming_response.retrieve_status(
                "taskId",
            )
        ) as response:
            assert not response.is_closed
