...
class TestBrand:
    ...
    def test_method_qualify_by_usecase(self, client: Telnyx) -> None:
        brand = client.messaging_10dlc.campaign_builder.brand.qualify_by_usecase(
            usecase="usecase",
            brand_id="brandId",
        )
    ...
    def test_raw_response_qualify_by_usecase(self, client: Telnyx) -> None:
        response = client.messaging_10dlc.campaign_builder.brand.with_raw_response.qualify_by_usecase(
            usecase="usecase",
            brand_id="brandId",
        )
    ...
    def test_streaming_response_qualify_by_usecase(self, client: Telnyx) -> None:
        with client.messaging_10dlc.campaign_builder.brand.with_streaming_response.qualify_by_usecase(
            usecase="usecase",
            brand_id="brandId",
        ) as response:
    ...
    def test_path_params_qualify_by_usecase(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            client.messaging_10dlc.campaign_builder.brand.with_raw_response.qualify_by_usecase(
                usecase="usecase",
                brand_id="",
            )
...
class TestAsyncBrand:
    ...
    async def test_method_qualify_by_usecase(self, async_client: AsyncTelnyx) -> None:
        brand = await async_client.messaging_10dlc.campaign_builder.brand.qualify_by_usecase(
            usecase="usecase",
            brand_id="brandId",
        )
        assert_matches_type(BrandQualifyByUsecaseResponse, brand, path=["response"])
    ...
    async def test_raw_response_qualify_by_usecase(self, async_client: AsyncTelnyx) -> None:
        response = await async_client.messaging_10dlc.campaign_builder.brand.with_raw_response.qualify_by_usecase(
            usecase="usecase",
            brand_id="brandId",
        )
    ...
    async def test_streaming_response_qualify_by_usecase(self, async_client: AsyncTelnyx) -> None:
        async with async_client.messaging_10dlc.campaign_builder.brand.with_streaming_response.qualify_by_usecase(
            usecase="usecase",
            brand_id="brandId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_qualify_by_usecase(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            await async_client.messaging_10dlc.campaign_builder.brand.with_raw_response.qualify_by_usecase(
                usecase="usecase",
                brand_id="",
            )
