...
class TestRoomParticipants:
    ...
    def test_method_list(self, client: Telnyx) -> None:
        ...
        assert_matches_type(SyncDefaultFlatPagination[RoomParticipant], room_participant, path=["response"])
...
class TestAsyncRoomParticipants:
    ...
    async def test_method_list(self, async_client: AsyncTelnyx) -> None:
        ...
        assert_matches_type(AsyncDefaultFlatPagination[RoomParticipant], room_participant, path=["response"])
