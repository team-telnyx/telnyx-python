...
class TestVerifyEmail:
    ...
    def test_method_confirm(self, client: Telnyx) -> None:
        ...
        assert_matches_type(VerifyEmailConfirmResponse, verify_email, path=["response"])
    ...
    def test_method_send(self, client: Telnyx) -> None:
        verify_email = client.dir.verify_email.send(
            "16635d38-75a6-4481-82e8-69af60e05011",
        )
        assert_matches_type(VerifyEmailSendResponse, verify_email, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_send(self, client: Telnyx) -> None:
        response = client.dir.verify_email.with_raw_response.send(
            "16635d38-75a6-4481-82e8-69af60e05011",
        )
    ...
    def test_streaming_response_send(self, client: Telnyx) -> None:
        with client.dir.verify_email.with_streaming_response.send(
            "16635d38-75a6-4481-82e8-69af60e05011",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_send(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `dir_id` but received ''"):
            client.dir.verify_email.with_raw_response.send(
                "",
            )
...
class TestAsyncVerifyEmail:
    ...
    async def test_method_send(self, async_client: AsyncTelnyx) -> None:
        verify_email = await async_client.dir.verify_email.send(
            "16635d38-75a6-4481-82e8-69af60e05011",
        )
        assert_matches_type(VerifyEmailSendResponse, verify_email, path=["response"])
    ...
    async def test_raw_response_send(self, async_client: AsyncTelnyx) -> None:
        response = await async_client.dir.verify_email.with_raw_response.send(
            "16635d38-75a6-4481-82e8-69af60e05011",
        )
    ...
    async def test_streaming_response_send(self, async_client: AsyncTelnyx) -> None:
        async with async_client.dir.verify_email.with_streaming_response.send(
            "16635d38-75a6-4481-82e8-69af60e05011",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_send(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `dir_id` but received ''"):
            await async_client.dir.verify_email.with_raw_response.send(
                "",
            )
