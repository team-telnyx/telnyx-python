...
class TestReferences:
    ...
    def test_method_create(self, client: Telnyx) -> None:
        ...
        assert_matches_type(ReferenceList, reference, path=["response"])
    ...
    def test_raw_response_create(self, client: Telnyx) -> None:
        response = client.dir.references.with_raw_response.create(
            dir_id="16635d38-75a6-4481-82e8-69af60e05011",
            business_references=[
                {
                    "email": "dana.reyes@example.com",
    ...
    def test_streaming_response_create(self, client: Telnyx) -> None:
        with client.dir.references.with_streaming_response.create(
            dir_id="16635d38-75a6-4481-82e8-69af60e05011",
            business_references=[
                {
                    "email": "dana.reyes@example.com",
    ...
    def test_path_params_create(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `dir_id` but received ''"):
            client.dir.references.with_raw_response.create(
                dir_id="",
                business_references=[
                    {
                        "email": "dana.reyes@example.com",
...
class TestAsyncReferences:
    ...
    async def test_method_create(self, async_client: AsyncTelnyx) -> None:
        reference = await async_client.dir.references.create(
            dir_id="16635d38-75a6-4481-82e8-69af60e05011",
            business_references=[
                {
                    "email": "dana.reyes@example.com",
    ...
    async def test_raw_response_create(self, async_client: AsyncTelnyx) -> None:
        response = await async_client.dir.references.with_raw_response.create(
            dir_id="16635d38-75a6-4481-82e8-69af60e05011",
            business_references=[
                {
                    "email": "dana.reyes@example.com",
    ...
    async def test_streaming_response_create(self, async_client: AsyncTelnyx) -> None:
        async with async_client.dir.references.with_streaming_response.create(
            dir_id="16635d38-75a6-4481-82e8-69af60e05011",
            business_references=[
                {
                    "email": "dana.reyes@example.com",
    ...
    async def test_path_params_create(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `dir_id` but received ''"):
            await async_client.dir.references.with_raw_response.create(
                dir_id="",
                business_references=[
                    {
                        "email": "dana.reyes@example.com",
