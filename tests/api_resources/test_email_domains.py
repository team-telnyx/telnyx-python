...
class TestEmailDomains:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_rotate_dkim(self, client: Telnyx) -> None:
        email_domain = client.email_domains.rotate_dkim(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(EmailDomainRotateDkimResponse, email_domain, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_rotate_dkim(self, client: Telnyx) -> None:
        response = client.email_domains.with_raw_response.rotate_dkim(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_rotate_dkim(self, client: Telnyx) -> None:
        with client.email_domains.with_streaming_response.rotate_dkim(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_rotate_dkim(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `domain_id` but received ''"):
            client.email_domains.with_raw_response.rotate_dkim(
                "",
            )
...
class TestAsyncEmailDomains:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_rotate_dkim(self, async_client: AsyncTelnyx) -> None:
        email_domain = await async_client.email_domains.rotate_dkim(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(EmailDomainRotateDkimResponse, email_domain, path=["response"])
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_rotate_dkim(self, async_client: AsyncTelnyx) -> None:
        response = await async_client.email_domains.with_raw_response.rotate_dkim(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_rotate_dkim(self, async_client: AsyncTelnyx) -> None:
        async with async_client.email_domains.with_streaming_response.rotate_dkim(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_rotate_dkim(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `domain_id` but received ''"):
            await async_client.email_domains.with_raw_response.rotate_dkim(
                "",
            )
