...
class TestSpeechToText:
    ...
    @parametrize
    def test_method_list_providers(self, client: Telnyx) -> None:
        speech_to_text = client.speech_to_text.list_providers()
        assert_matches_type(SpeechToTextListProvidersResponse, speech_to_text, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_list_providers_with_all_params(self, client: Telnyx) -> None:
        speech_to_text = client.speech_to_text.list_providers(
            provider="deepgram",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_list_providers(self, client: Telnyx) -> None:
        response = client.speech_to_text.with_raw_response.list_providers()
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_list_providers(self, client: Telnyx) -> None:
        with client.speech_to_text.with_streaming_response.list_providers() as response:
...
class TestAsyncSpeechToText:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_list_providers(self, async_client: AsyncTelnyx) -> None:
        speech_to_text = await async_client.speech_to_text.list_providers()
        assert_matches_type(SpeechToTextListProvidersResponse, speech_to_text, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_list_providers_with_all_params(self, async_client: AsyncTelnyx) -> None:
        speech_to_text = await async_client.speech_to_text.list_providers(
            provider="deepgram",
            service_type="streaming",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_list_providers(self, async_client: AsyncTelnyx) -> None:
        response = await async_client.speech_to_text.with_raw_response.list_providers()
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_list_providers(self, async_client: AsyncTelnyx) -> None:
        async with async_client.speech_to_text.with_streaming_response.list_providers() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
