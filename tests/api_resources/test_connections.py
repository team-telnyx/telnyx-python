...
class TestConnections:
    ...
    def test_method_list(self, client: Telnyx) -> None:
        ...
        assert_matches_type(SyncDefaultFlatPagination[ConnectionListResponse], connection, path=["response"])
    ...
    def test_method_list_active_calls(self, client: Telnyx) -> None:
        ...
        assert_matches_type(SyncDefaultFlatPagination[ConnectionListActiveCallsResponse], connection, path=["response"])
    ...
    def test_streaming_response_list_active_calls(self, client: Telnyx) -> None:
        with client.connections.with_streaming_response.list_active_calls(
            ...
            connection = response.parse()
            assert_matches_type(
                SyncDefaultFlatPagination[ConnectionListActiveCallsResponse], connection, path=["response"]
            )
...
class TestAsyncConnections:
    ...
    async def test_method_list(self, async_client: AsyncTelnyx) -> None:
        ...
        assert_matches_type(AsyncDefaultFlatPagination[ConnectionListResponse], connection, path=["response"])
    ...
    async def test_method_list_active_calls(self, async_client: AsyncTelnyx) -> None:
        ...
        assert_matches_type(
            AsyncDefaultFlatPagination[ConnectionListActiveCallsResponse], connection, path=["response"]
        )
