...
from telnyx.types.porting import EventListResponse, EventRetrieveResponse
...
class TestEvents:
    ...
    def test_path_params_retrieve(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.porting.events.with_raw_response.retrieve(
                "",
            )
    ...
    def test_method_list(self, client: Telnyx) -> None:
        ...
        assert_matches_type(SyncDefaultPagination[EventListResponse], event, path=["response"])
    ...
    def test_method_list_with_all_params(self, client: Telnyx) -> None:
        event = client.porting.events.list(
            filter={
                ...
                "porting_order_id": "34dc46a9-53ed-4e01-9454-26227ea13326",
    ...
    def test_path_params_republish(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.porting.events.with_raw_response.republish(
                "",
            )
...
class TestAsyncEvents:
    ...
    async def test_path_params_retrieve(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.porting.events.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_method_list(self, async_client: AsyncTelnyx) -> None:
        ...
        assert_matches_type(AsyncDefaultPagination[EventListResponse], event, path=["response"])
    ...
    async def test_path_params_republish(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.porting.events.with_raw_response.republish(
                "",
            )
