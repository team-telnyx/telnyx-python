...
from telnyx.types.porting import PortingEvent, EventRetrieveResponse
...
class TestEvents:
    ...
    def test_method_list(self, client: Telnyx) -> None:
        ...
        assert_matches_type(SyncDefaultFlatPagination[PortingEvent], event, path=["response"])
...
class TestAsyncEvents:
    ...
    async def test_method_list(self, async_client: AsyncTelnyx) -> None:
        ...
        assert_matches_type(AsyncDefaultFlatPagination[PortingEvent], event, path=["response"])
