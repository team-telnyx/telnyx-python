...
class TestExternalVetting:
    ...
    def test_method_imports(self, client: Telnyx) -> None:
        external_vetting = client.brand.external_vetting.imports(
            brand_id="brandId",
            evp_id="evpId",
    ...
    def test_raw_response_imports(self, client: Telnyx) -> None:
        response = client.brand.external_vetting.with_raw_response.imports(
            brand_id="brandId",
            evp_id="evpId",
            vetting_id="vettingId",
        )
    ...
    def test_streaming_response_imports(self, client: Telnyx) -> None:
        with client.brand.external_vetting.with_streaming_response.imports(
            brand_id="brandId",
            evp_id="evpId",
            vetting_id="vettingId",
        ) as response:
    ...
    def test_path_params_imports(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            client.brand.external_vetting.with_raw_response.imports(
                brand_id="",
                evp_id="evpId",
                vetting_id="vettingId",
            )
...
class TestAsyncExternalVetting:
    ...
    async def test_method_imports(self, async_client: AsyncTelnyx) -> None:
        external_vetting = await async_client.brand.external_vetting.imports(
            brand_id="brandId",
            evp_id="evpId",
            vetting_id="vettingId",
        )
    ...
    async def test_raw_response_imports(self, async_client: AsyncTelnyx) -> None:
        response = await async_client.brand.external_vetting.with_raw_response.imports(
            brand_id="brandId",
            evp_id="evpId",
            vetting_id="vettingId",
        )
    ...
    async def test_streaming_response_imports(self, async_client: AsyncTelnyx) -> None:
        async with async_client.brand.external_vetting.with_streaming_response.imports(
            brand_id="brandId",
            evp_id="evpId",
            vetting_id="vettingId",
        ) as response:
    ...
    async def test_path_params_imports(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            await async_client.brand.external_vetting.with_raw_response.imports(
                brand_id="",
                evp_id="evpId",
                vetting_id="vettingId",
            )
