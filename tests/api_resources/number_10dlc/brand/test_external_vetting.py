...
class TestExternalVetting:
    ...
    def test_method_list(self, client: Telnyx) -> None:
        external_vetting = client.number_10dlc.brand.external_vetting.list(
            "brandId",
        )
    ...
    def test_raw_response_list(self, client: Telnyx) -> None:
        response = client.number_10dlc.brand.external_vetting.with_raw_response.list(
            "brandId",
        )
    ...
    def test_streaming_response_list(self, client: Telnyx) -> None:
        with client.number_10dlc.brand.external_vetting.with_streaming_response.list(
            "brandId",
        ) as response:
    ...
    def test_path_params_list(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            client.number_10dlc.brand.external_vetting.with_raw_response.list(
                "",
            )
    ...
    def test_method_order(self, client: Telnyx) -> None:
        external_vetting = client.number_10dlc.brand.external_vetting.order(
            brand_id="brandId",
            evp_id="evpId",
    ...
    def test_raw_response_order(self, client: Telnyx) -> None:
        response = client.number_10dlc.brand.external_vetting.with_raw_response.order(
            brand_id="brandId",
            evp_id="evpId",
            vetting_class="vettingClass",
        )
    ...
    def test_streaming_response_order(self, client: Telnyx) -> None:
        with client.number_10dlc.brand.external_vetting.with_streaming_response.order(
            brand_id="brandId",
            evp_id="evpId",
            vetting_class="vettingClass",
        ) as response:
    ...
    def test_path_params_order(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            client.number_10dlc.brand.external_vetting.with_raw_response.order(
                brand_id="",
                evp_id="evpId",
                vetting_class="vettingClass",
            )
...
class TestAsyncExternalVetting:
    ...
    async def test_method_list(self, async_client: AsyncTelnyx) -> None:
        external_vetting = await async_client.number_10dlc.brand.external_vetting.list(
            "brandId",
        )
        assert_matches_type(ExternalVettingListResponse, external_vetting, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncTelnyx) -> None:
        response = await async_client.number_10dlc.brand.external_vetting.with_raw_response.list(
            "brandId",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncTelnyx) -> None:
        async with async_client.number_10dlc.brand.external_vetting.with_streaming_response.list(
            "brandId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            await async_client.number_10dlc.brand.external_vetting.with_raw_response.list(
                "",
            )
    ...
    async def test_method_order(self, async_client: AsyncTelnyx) -> None:
        external_vetting = await async_client.number_10dlc.brand.external_vetting.order(
            brand_id="brandId",
            evp_id="evpId",
            vetting_class="vettingClass",
        )
    ...
    async def test_raw_response_order(self, async_client: AsyncTelnyx) -> None:
        response = await async_client.number_10dlc.brand.external_vetting.with_raw_response.order(
            brand_id="brandId",
            evp_id="evpId",
            vetting_class="vettingClass",
        )
    ...
    async def test_streaming_response_order(self, async_client: AsyncTelnyx) -> None:
        async with async_client.number_10dlc.brand.external_vetting.with_streaming_response.order(
            brand_id="brandId",
            evp_id="evpId",
            vetting_class="vettingClass",
        ) as response:
    ...
    async def test_path_params_order(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `brand_id` but received ''"):
            await async_client.number_10dlc.brand.external_vetting.with_raw_response.order(
                brand_id="",
                evp_id="evpId",
                vetting_class="vettingClass",
            )
