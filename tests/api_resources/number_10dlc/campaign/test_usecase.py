...
class TestUsecase:
    ...
    def test_method_get_cost(self, client: Telnyx) -> None:
        usecase = client.number_10dlc.campaign.usecase.get_cost(
            usecase="usecase",
        )
    ...
    def test_raw_response_get_cost(self, client: Telnyx) -> None:
        response = client.number_10dlc.campaign.usecase.with_raw_response.get_cost(
            usecase="usecase",
        )
    ...
    def test_streaming_response_get_cost(self, client: Telnyx) -> None:
        with client.number_10dlc.campaign.usecase.with_streaming_response.get_cost(
            usecase="usecase",
        ) as response:
...
class TestAsyncUsecase:
    ...
    async def test_method_get_cost(self, async_client: AsyncTelnyx) -> None:
        usecase = await async_client.number_10dlc.campaign.usecase.get_cost(
            usecase="usecase",
        )
        assert_matches_type(UsecaseGetCostResponse, usecase, path=["response"])
    ...
    async def test_raw_response_get_cost(self, async_client: AsyncTelnyx) -> None:
        response = await async_client.number_10dlc.campaign.usecase.with_raw_response.get_cost(
            usecase="usecase",
        )
    ...
    async def test_streaming_response_get_cost(self, async_client: AsyncTelnyx) -> None:
        async with async_client.number_10dlc.campaign.usecase.with_streaming_response.get_cost(
            usecase="usecase",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
