...
class TestWebhooks:
    ...
    def test_method_unwrap(self, client: Telnyx, client_opt: str | None, method_opt: str | bytes | None) -> None:
        hook = standardwebhooks.Webhook(b"secret\n")

        client = client.with_options(public_key=client_opt)
...
class TestAsyncWebhooks:
    ...
    def test_method_unwrap(self, async_client: Telnyx, client_opt: str | None, method_opt: str | bytes | None) -> None:
        hook = standardwebhooks.Webhook(b"secret\n")

        async_client = async_client.with_options(public_key=client_opt)
