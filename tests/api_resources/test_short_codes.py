...
class TestShortCodes:
    ...
    def test_method_list(self, client: Telnyx) -> None:
        ...
        assert_matches_type(SyncDefaultFlatPagination[ShortCode], short_code, path=["response"])
...
class TestAsyncShortCodes:
    ...
    async def test_method_list(self, async_client: AsyncTelnyx) -> None:
        ...
        assert_matches_type(AsyncDefaultFlatPagination[ShortCode], short_code, path=["response"])
