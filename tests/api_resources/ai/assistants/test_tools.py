...
class TestTools:
    ...
    def test_method_add(self, client: Telnyx) -> None:
        tool = client.ai.assistants.tools.add(
            tool_id="tool_id",
    ...
    def test_raw_response_add(self, client: Telnyx) -> None:
        response = client.ai.assistants.tools.with_raw_response.add(
            tool_id="tool_id",
            assistant_id="assistant_id",
        )
    ...
    def test_streaming_response_add(self, client: Telnyx) -> None:
        with client.ai.assistants.tools.with_streaming_response.add(
            tool_id="tool_id",
            assistant_id="assistant_id",
        ) as response:
    ...
    def test_path_params_add(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `assistant_id` but received ''"):
            client.ai.assistants.tools.with_raw_response.add(
                tool_id="tool_id",
                assistant_id="",
            )
    ...
    def test_raw_response_remove(self, client: Telnyx) -> None:
        response = client.ai.assistants.tools.with_raw_response.remove(
            tool_id="tool_id",
            assistant_id="assistant_id",
        )
    ...
    def test_streaming_response_remove(self, client: Telnyx) -> None:
        with client.ai.assistants.tools.with_streaming_response.remove(
            tool_id="tool_id",
            assistant_id="assistant_id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_remove(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `assistant_id` but received ''"):
            client.ai.assistants.tools.with_raw_response.remove(
                tool_id="tool_id",
                assistant_id="",
            )
...
class TestAsyncTools:
    ...
    async def test_method_add(self, async_client: AsyncTelnyx) -> None:
        tool = await async_client.ai.assistants.tools.add(
            tool_id="tool_id",
            assistant_id="assistant_id",
        )
        assert_matches_type(object, tool, path=["response"])
    ...
    async def test_raw_response_add(self, async_client: AsyncTelnyx) -> None:
        response = await async_client.ai.assistants.tools.with_raw_response.add(
            tool_id="tool_id",
            assistant_id="assistant_id",
        )
    ...
    async def test_streaming_response_add(self, async_client: AsyncTelnyx) -> None:
        async with async_client.ai.assistants.tools.with_streaming_response.add(
            tool_id="tool_id",
            assistant_id="assistant_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_add(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `assistant_id` but received ''"):
            await async_client.ai.assistants.tools.with_raw_response.add(
                tool_id="tool_id",
                assistant_id="",
            )
    ...
    async def test_method_remove(self, async_client: AsyncTelnyx) -> None:
        tool = await async_client.ai.assistants.tools.remove(
            tool_id="tool_id",
            assistant_id="assistant_id",
        )
        assert_matches_type(object, tool, path=["response"])
    ...
    async def test_raw_response_remove(self, async_client: AsyncTelnyx) -> None:
        response = await async_client.ai.assistants.tools.with_raw_response.remove(
            tool_id="tool_id",
            assistant_id="assistant_id",
        )
    ...
    async def test_streaming_response_remove(self, async_client: AsyncTelnyx) -> None:
        async with async_client.ai.assistants.tools.with_streaming_response.remove(
            tool_id="tool_id",
            assistant_id="assistant_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_remove(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `assistant_id` but received ''"):
            await async_client.ai.assistants.tools.with_raw_response.remove(
                tool_id="tool_id",
                assistant_id="",
            )
