...
class TestMessages:
    ...
    def test_method_list(self, client: Telnyx) -> None:
        ...
        assert_matches_type(SyncDefaultFlatPagination[MessageListResponse], message, path=["response"])
...
class TestAsyncMessages:
    ...
    async def test_method_list(self, async_client: AsyncTelnyx) -> None:
        ...
        assert_matches_type(AsyncDefaultFlatPagination[MessageListResponse], message, path=["response"])
