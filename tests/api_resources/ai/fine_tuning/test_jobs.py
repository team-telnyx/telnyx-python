...
class TestJobs:
    ...
    def test_path_params_retrieve(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            client.ai.fine_tuning.jobs.with_raw_response.retrieve(
                "",
            )
    ...
    def test_path_params_cancel(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            client.ai.fine_tuning.jobs.with_raw_response.cancel(
                "",
            )
...
class TestAsyncJobs:
    ...
    async def test_path_params_retrieve(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            await async_client.ai.fine_tuning.jobs.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_path_params_cancel(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `job_id` but received ''"):
            await async_client.ai.fine_tuning.jobs.with_raw_response.cancel(
                "",
            )
