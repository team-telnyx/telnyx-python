...
class TestJson:
    ...
    def test_path_params_delete_recording_transcription_sid_json(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_sid` but received ''"):
            client.texml.accounts.transcriptions.json.with_raw_response.delete_recording_transcription_sid_json(
                recording_transcription_sid="6a09cdc3-8948-47f0-aa62-74ac943d6c58",
                account_sid="",
            )

        with pytest.raises(
            ValueError, match=r"Expected a non-empty value for `recording_transcription_sid` but received ''"
        ):
            client.texml.accounts.transcriptions.json.with_raw_response.delete_recording_transcription_sid_json(
    ...
    def test_raw_response_retrieve_recording_transcription_sid_json(self, client: Telnyx) -> None:
        response = (
            client.texml.accounts.transcriptions.json.with_raw_response.retrieve_recording_transcription_sid_json(
                recording_transcription_sid="6a09cdc3-8948-47f0-aa62-74ac943d6c58",
                account_sid="account_sid",
            )
        )
    ...
    def test_streaming_response_retrieve_recording_transcription_sid_json(self, client: Telnyx) -> None:
        with (
            client.texml.accounts.transcriptions.json.with_streaming_response.retrieve_recording_transcription_sid_json(
                recording_transcription_sid="6a09cdc3-8948-47f0-aa62-74ac943d6c58",
                account_sid="account_sid",
            )
        ) as response:
...
class TestAsyncJson:
    ...
    async def test_path_params_delete_recording_transcription_sid_json(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_sid` but received ''"):
            await async_client.texml.accounts.transcriptions.json.with_raw_response.delete_recording_transcription_sid_json(
                recording_transcription_sid="6a09cdc3-8948-47f0-aa62-74ac943d6c58",
                account_sid="",
            )
    ...
    async def test_streaming_response_retrieve_recording_transcription_sid_json(
        ...
        async with async_client.texml.accounts.transcriptions.json.with_streaming_response.retrieve_recording_transcription_sid_json(
            recording_transcription_sid="6a09cdc3-8948-47f0-aa62-74ac943d6c58",
            account_sid="account_sid",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve_recording_transcription_sid_json(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `account_sid` but received ''"):
            await async_client.texml.accounts.transcriptions.json.with_raw_response.retrieve_recording_transcription_sid_json(
                recording_transcription_sid="6a09cdc3-8948-47f0-aa62-74ac943d6c58",
                account_sid="",
            )
