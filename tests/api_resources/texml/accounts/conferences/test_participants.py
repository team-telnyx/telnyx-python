...
class TestParticipants:
    ...
    def test_method_participants_with_all_params(self, client: Telnyx) -> None:
        participant = client.texml.accounts.conferences.participants.participants(
            ...
            application_sid="1846572522338780702",
            beep="onExit",
            caller_id="Info",
            call_sid_to_coach="v3:9X2vxPDFY2RHSJ1EdMS0RHRksMTg7ldNxdjWbVr9zBjbGjGsSe-aiQ",
            ...
            machine_detection_beep_max_frequency=2000,
            machine_detection_beep_min_frequency=550,
            machine_detection_beep_min_tone_duration=300,
            machine_detection_beep_profile="freq_only",
            machine_detection_beep_spectral_confirmation=True,
            machine_detection_beep_spectral_min_purity=0.8,
            machine_detection_beep_spectral_reject_fax_cng=True,
            machine_detection_beep_spectral_window=100,
