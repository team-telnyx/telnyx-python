...
class TestPhoneNumberAssignmentByProfile:
    ...
    def test_method_list_phone_number_status(self, client: Telnyx) -> None:
        phone_number_assignment_by_profile = client.phone_number_assignment_by_profile.list_phone_number_status(
            task_id="taskId",
        )
        assert_matches_type(
            PhoneNumberAssignmentByProfileListPhoneNumberStatusResponse,
    ...
    def test_raw_response_list_phone_number_status(self, client: Telnyx) -> None:
        response = client.phone_number_assignment_by_profile.with_raw_response.list_phone_number_status(
            task_id="taskId",
        )
    ...
    def test_streaming_response_list_phone_number_status(self, client: Telnyx) -> None:
        with client.phone_number_assignment_by_profile.with_streaming_response.list_phone_number_status(
            task_id="taskId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list_phone_number_status(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `task_id` but received ''"):
            client.phone_number_assignment_by_profile.with_raw_response.list_phone_number_status(
                task_id="",
            )
...
class TestAsyncPhoneNumberAssignmentByProfile:
    ...
    async def test_method_list_phone_number_status(self, async_client: AsyncTelnyx) -> None:
        phone_number_assignment_by_profile = (
            await async_client.phone_number_assignment_by_profile.list_phone_number_status(
                task_id="taskId",
            )
        )
        assert_matches_type(
    ...
    async def test_raw_response_list_phone_number_status(self, async_client: AsyncTelnyx) -> None:
        response = await async_client.phone_number_assignment_by_profile.with_raw_response.list_phone_number_status(
            task_id="taskId",
        )
    ...
    async def test_streaming_response_list_phone_number_status(self, async_client: AsyncTelnyx) -> None:
        async with async_client.phone_number_assignment_by_profile.with_streaming_response.list_phone_number_status(
            task_id="taskId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list_phone_number_status(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `task_id` but received ''"):
            await async_client.phone_number_assignment_by_profile.with_raw_response.list_phone_number_status(
                task_id="",
            )
