...
class TestInboundChannels(object):
    def test_is_retrievable(self, request_mock):
        ...
        # Patch: onvert list to string to match, prism mock issue
        if isinstance(resource.record_type, list):
            resource.record_type = resource.record_type[0]
    ...
    def test_is_saveable(self, request_mock):
        ...
        # Patch
        if isinstance(inbound_channels.record_type, list):
            inbound_channels.record_type = inbound_channels.record_type[0]
