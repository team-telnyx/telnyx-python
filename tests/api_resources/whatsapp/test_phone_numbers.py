...
class TestPhoneNumbers:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_get_conversation_window(self, client: Telnyx) -> None:
        phone_number = client.whatsapp.phone_numbers.get_conversation_window(
            phone_number="phone_number",
            destination_number="+353894650851",
        )
        assert_matches_type(PhoneNumberGetConversationWindowResponse, phone_number, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_get_conversation_window(self, client: Telnyx) -> None:
        response = client.whatsapp.phone_numbers.with_raw_response.get_conversation_window(
            phone_number="phone_number",
            destination_number="+353894650851",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_get_conversation_window(self, client: Telnyx) -> None:
        with client.whatsapp.phone_numbers.with_streaming_response.get_conversation_window(
            phone_number="phone_number",
            destination_number="+353894650851",
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_get_conversation_window(self, client: Telnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `phone_number` but received ''"):
            client.whatsapp.phone_numbers.with_raw_response.get_conversation_window(
                phone_number="",
                destination_number="+353894650851",
            )
...
class TestAsyncPhoneNumbers:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_get_conversation_window(self, async_client: AsyncTelnyx) -> None:
        phone_number = await async_client.whatsapp.phone_numbers.get_conversation_window(
            phone_number="phone_number",
            destination_number="+353894650851",
        )
        assert_matches_type(PhoneNumberGetConversationWindowResponse, phone_number, path=["response"])
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_get_conversation_window(self, async_client: AsyncTelnyx) -> None:
        response = await async_client.whatsapp.phone_numbers.with_raw_response.get_conversation_window(
            phone_number="phone_number",
            destination_number="+353894650851",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_get_conversation_window(self, async_client: AsyncTelnyx) -> None:
        async with async_client.whatsapp.phone_numbers.with_streaming_response.get_conversation_window(
            phone_number="phone_number",
            destination_number="+353894650851",
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_get_conversation_window(self, async_client: AsyncTelnyx) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `phone_number` but received ''"):
            await async_client.whatsapp.phone_numbers.with_raw_response.get_conversation_window(
                phone_number="",
                destination_number="+353894650851",
            )
