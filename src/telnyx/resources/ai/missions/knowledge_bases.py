...
class KnowledgeBasesResourceWithRawResponse:
    def __init__(self, knowledge_bases: KnowledgeBasesResource) -> None:
        ...
        self.delete_knowledge_base = to_raw_response_wrapper(
            knowledge_bases.delete_knowledge_base,
        )
        self.get_knowledge_base = to_raw_response_wrapper(
            knowledge_bases.get_knowledge_base,
        )
        self.list_knowledge_bases = to_raw_response_wrapper(
            knowledge_bases.list_knowledge_bases,
        )
        self.update_knowledge_base = to_raw_response_wrapper(
...
class AsyncKnowledgeBasesResourceWithRawResponse:
    def __init__(self, knowledge_bases: AsyncKnowledgeBasesResource) -> None:
        ...
        self.delete_knowledge_base = async_to_raw_response_wrapper(
            knowledge_bases.delete_knowledge_base,
        )
        self.get_knowledge_base = async_to_raw_response_wrapper(
            knowledge_bases.get_knowledge_base,
        )
        self.list_knowledge_bases = async_to_raw_response_wrapper(
            knowledge_bases.list_knowledge_bases,
        )
        self.update_knowledge_base = async_to_raw_response_wrapper(
            knowledge_bases.update_knowledge_base,
        )
...
class KnowledgeBasesResourceWithStreamingResponse:
    def __init__(self, knowledge_bases: KnowledgeBasesResource) -> None:
        ...
        self.delete_knowledge_base = to_streamed_response_wrapper(
            knowledge_bases.delete_knowledge_base,
        )
        self.get_knowledge_base = to_streamed_response_wrapper(
            knowledge_bases.get_knowledge_base,
        )
        self.list_knowledge_bases = to_streamed_response_wrapper(
            knowledge_bases.list_knowledge_bases,
        )
        self.update_knowledge_base = to_streamed_response_wrapper(
            knowledge_bases.update_knowledge_base,
        )
...
class AsyncKnowledgeBasesResourceWithStreamingResponse:
    def __init__(self, knowledge_bases: AsyncKnowledgeBasesResource) -> None:
        ...
        self.delete_knowledge_base = async_to_streamed_response_wrapper(
            knowledge_bases.delete_knowledge_base,
        )
        self.get_knowledge_base = async_to_streamed_response_wrapper(
            knowledge_bases.get_knowledge_base,
        )
        self.list_knowledge_bases = async_to_streamed_response_wrapper(
            knowledge_bases.list_knowledge_bases,
        )
        self.update_knowledge_base = async_to_streamed_response_wrapper(
            knowledge_bases.update_knowledge_base,
        )
