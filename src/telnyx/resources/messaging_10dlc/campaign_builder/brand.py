...
from ....types.messaging_10dlc.campaign_builder.brand_qualify_by_usecase_response import BrandQualifyByUsecaseResponse
...
class BrandResource(SyncAPIResource):
    ...
    def qualify_by_usecase(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/10dlc/campaignBuilder/brand/{brand_id}/usecase/{usecase}", brand_id=brand_id, usecase=usecase
            ),
