...
from ....types.messaging_10dlc import campaign_list_params, campaign_update_params, campaign_submit_appeal_params
from ....types.messaging_10dlc.telnyx_campaign_csp import TelnyxCampaignCsp
from ....types.messaging_10dlc.campaign_list_response import CampaignListResponse
from ....types.messaging_10dlc.campaign_deactivate_response import CampaignDeactivateResponse
from ....types.messaging_10dlc.campaign_submit_appeal_response import CampaignSubmitAppealResponse
from ....types.messaging_10dlc.campaign_accept_sharing_response import CampaignAcceptSharingResponse
from ....types.messaging_10dlc.campaign_get_mno_metadata_response import CampaignGetMnoMetadataResponse
from ....types.messaging_10dlc.campaign_get_sharing_status_response import CampaignGetSharingStatusResponse
from ....types.messaging_10dlc.campaign_get_operation_status_response import CampaignGetOperationStatusResponse
...
class CampaignResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/10dlc/campaign/{campaign_id}", campaign_id=campaign_id),
    ...
    def accept_sharing(
        ...
        *,
        ...
        if not campaign_id:
            raise ValueError(f"Expected a non-empty value for `campaign_id` but received {campaign_id!r}")
        return self._post(
            path_template("/10dlc/campaign/acceptSharing/{campaign_id}", campaign_id=campaign_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def get_mno_metadata(
        ...
        *,
        ...
        if not campaign_id:
            raise ValueError(f"Expected a non-empty value for `campaign_id` but received {campaign_id!r}")
        return self._get(
            path_template("/10dlc/campaign/{campaign_id}/mnoMetadata", campaign_id=campaign_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def get_operation_status(
        ...
        *,
        ...
        if not campaign_id:
            raise ValueError(f"Expected a non-empty value for `campaign_id` but received {campaign_id!r}")
        return self._get(
            path_template("/10dlc/campaign/{campaign_id}/operationStatus", campaign_id=campaign_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def get_sharing_status(
        ...
        *,
        ...
        if not campaign_id:
            raise ValueError(f"Expected a non-empty value for `campaign_id` but received {campaign_id!r}")
        return self._get(
            path_template("/10dlc/campaign/{campaign_id}/sharing", campaign_id=campaign_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def submit_appeal(
        ...
        *,
        ...
        if not campaign_id:
            raise ValueError(f"Expected a non-empty value for `campaign_id` but received {campaign_id!r}")
        return self._post(
            path_template("/10dlc/campaign/{campaign_id}/appeal", campaign_id=campaign_id),
            body=maybe_transform(
