...
from ...types.messaging_profiles.action_regenerate_secret_response import ActionRegenerateSecretResponse
...
class ActionsResource(SyncAPIResource):
    ...
    def regenerate_secret(
        ...
        *,
        ...
        return self._post(
            path_template("/messaging_profiles/{id}/actions/regenerate_secret", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ActionRegenerateSecretResponse,
        )
