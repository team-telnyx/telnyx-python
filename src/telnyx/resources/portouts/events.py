...
class EventsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        page: event_list_params.Page | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
    ...
    def republish(
        ...
        *,
        ...
        return self._post(
            f"/portouts/events/{id}/republish",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class EventsResourceWithRawResponse:
    def __init__(self, events: EventsResource) -> None:
        ...
        self.republish = to_raw_response_wrapper(
            events.republish,
        )
...
class AsyncEventsResourceWithRawResponse:
    def __init__(self, events: AsyncEventsResource) -> None:
        ...
        self.republish = async_to_raw_response_wrapper(
            events.republish,
        )
...
class EventsResourceWithStreamingResponse:
    def __init__(self, events: EventsResource) -> None:
        ...
        self.republish = to_streamed_response_wrapper(
            events.republish,
        )
...
class AsyncEventsResourceWithStreamingResponse:
    def __init__(self, events: AsyncEventsResource) -> None:
        ...
        self.republish = async_to_streamed_response_wrapper(
            events.republish,
        )
