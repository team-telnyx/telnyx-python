...
from ...types.portouts import report_list_params, report_create_params
...
class ReportsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Args:
          params: The parameters for generating a port-outs CSV report.
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/portouts/reports/{id}", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> SyncDefaultFlatPagination[PortoutReport]:
        """
        ...
        return self._get_api_list(
            "/portouts/reports",
            page=SyncDefaultFlatPagination[PortoutReport],
            options=make_request_options(
...
class AsyncReportsResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> AsyncPaginator[PortoutReport, AsyncDefaultFlatPagination[PortoutReport]]:
        """
        List the reports generated about port-out operations.
        ...
        return self._get_api_list(
            "/portouts/reports",
            page=AsyncDefaultFlatPagination[PortoutReport],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
