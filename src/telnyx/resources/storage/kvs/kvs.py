...
from ....types.storage.kv_list_response import KvListResponse
from ....types.storage.kv_create_response import KvCreateResponse
from ....types.storage.kv_delete_response import KvDeleteResponse
from ....types.storage.kv_retrieve_response import KvRetrieveResponse
...
class KvsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> SyncDefaultFlatPagination[KvListResponse]:
        ...
        return self._get_api_list(
            "/storage/kvs",
            page=SyncDefaultFlatPagination[KvListResponse],
            options=make_request_options(
...
class AsyncKvsResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> AsyncPaginator[KvListResponse, AsyncDefaultFlatPagination[KvListResponse]]:
        """Lists the KV namespaces for the authenticated user's organization.
        ...
        return self._get_api_list(
            "/storage/kvs",
            page=AsyncDefaultFlatPagination[KvListResponse],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
