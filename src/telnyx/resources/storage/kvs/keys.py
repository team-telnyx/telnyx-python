        ...
        *,
        ...
        return self._put(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"ttl_secs": ttl_secs}, key_update_params.KeyUpdateParams),
            ),
            cast_to=NoneType,
        )
        ...
        *,
        ...
        return await self._put(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"ttl_secs": ttl_secs}, key_update_params.KeyUpdateParams),
            ),
            cast_to=NoneType,
        )
