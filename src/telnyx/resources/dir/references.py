...
class ReferencesResource(SyncAPIResource):
    ...
    def create(
        ...
        dir_id: str,
        *,
        business_references: Iterable[ReferenceInputParam],
        financial_reference: ReferenceInputParam,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                reference_create_params.ReferenceCreateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ReferenceList,
        )
