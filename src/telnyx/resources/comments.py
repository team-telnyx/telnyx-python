...
from ..types import comment_list_params, comment_create_params
...
from ..types.comment_mark_as_read_response import CommentMarkAsReadResponse
...
class CommentsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        body: str | Omit = omit,
        comment_record_id: str | Omit = omit,
        comment_record_type: Literal["sub_number_order", "requirement_group"] | Omit = omit,
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/comments/{id}", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    def list(
        self,
        *,
        filter: comment_list_params.Filter | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"filter": filter}, comment_list_params.CommentListParams),
            ),
    ...
    def mark_as_read(
        ...
        *,
        ...
        if not id:
            raise ValueError(f"Expected a non-empty value for `id` but received {id!r}")
        return self._patch(
            path_template("/comments/{id}/read", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=CommentMarkAsReadResponse,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"filter": filter}, comment_list_params.CommentListParams),
            ),
            cast_to=CommentListResponse,
        )
