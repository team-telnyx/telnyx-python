...
from ....types.email_inboxes.threads import label_create_params, label_delete_all_params
from ....types.email_inboxes.threads.label_create_response import LabelCreateResponse
from ....types.email_inboxes.threads.label_delete_all_response import LabelDeleteAllResponse
...
class LabelsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            path_template(
                "/email_inboxes/{inbox_id}/threads/{thread_id}/labels", inbox_id=inbox_id, thread_id=thread_id
            ),
    ...
    def delete_all(
        ...
        *,
        ...
        """Removes one or more labels from a thread.
