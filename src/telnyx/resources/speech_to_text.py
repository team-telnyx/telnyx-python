...
from ..types import SttServiceType, speech_to_text_list_providers_params, speech_to_text_retrieve_transcription_params
...
from ..types.stt_service_type import SttServiceType
    ...
    def retrieve_transcription(
        ...
        **Connection flow:**
        ...
        Args:
          ...
          endpointing: Silence duration (in milliseconds) that triggers end-of-speech detection. When
        ...
        return self._get(
            "/speech-to-text/transcription"
            if self._client._base_url_overridden
            else "wss://api.telnyx.com/v2/speech-to-text/transcription",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
...
class SpeechToTextResourceWithRawResponse:
    def __init__(self, speech_to_text: SpeechToTextResource) -> None:
        ...
        self.retrieve_transcription = to_raw_response_wrapper(
            speech_to_text.retrieve_transcription,
        )
...
class AsyncSpeechToTextResourceWithRawResponse:
    def __init__(self, speech_to_text: AsyncSpeechToTextResource) -> None:
        ...
        self.retrieve_transcription = async_to_raw_response_wrapper(
            speech_to_text.retrieve_transcription,
        )
...
class SpeechToTextResourceWithStreamingResponse:
    def __init__(self, speech_to_text: SpeechToTextResource) -> None:
        ...
        self.retrieve_transcription = to_streamed_response_wrapper(
            speech_to_text.retrieve_transcription,
        )
...
class AsyncSpeechToTextResourceWithStreamingResponse:
    def __init__(self, speech_to_text: AsyncSpeechToTextResource) -> None:
        ...
        self.retrieve_transcription = async_to_streamed_response_wrapper(
            speech_to_text.retrieve_transcription,
        )
