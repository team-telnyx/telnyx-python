...
from ...types.porting_orders.porting_orders_comment import PortingOrdersComment
...
class CommentsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> SyncDefaultFlatPagination[PortingOrdersComment]:
        """
        ...
        return self._get_api_list(
            path_template("/porting_orders/{id}/comments", id=id),
            page=SyncDefaultFlatPagination[PortingOrdersComment],
            options=make_request_options(
...
class AsyncCommentsResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> AsyncPaginator[PortingOrdersComment, AsyncDefaultFlatPagination[PortingOrdersComment]]:
        """
        Returns a list of all comments of a porting order.
        ...
        return self._get_api_list(
            path_template("/porting_orders/{id}/comments", id=id),
            page=AsyncDefaultFlatPagination[PortingOrdersComment],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
