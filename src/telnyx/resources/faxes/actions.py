...
from ...types.faxes.action_cancel_response import ActionCancelResponse
from ...types.faxes.action_refresh_response import ActionRefreshResponse
...
class ActionsResource(SyncAPIResource):
    ...
    def cancel(
        ...
        *,
        ...
        return self._post(
            path_template("/faxes/{id}/actions/cancel", id=id),
    ...
    def refresh(
        ...
        *,
        ...
        if not id:
            raise ValueError(f"Expected a non-empty value for `id` but received {id!r}")
        return self._post(
            path_template("/faxes/{id}/actions/refresh", id=id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
