...
class JsonResource(SyncAPIResource):
    ...
    def delete_recording_sid_json(
        ...
        *,
        ...
        return self._delete(
            f"/texml/Accounts/{account_sid}/Recordings/{recording_sid}.json",
...
class AsyncJsonResource(AsyncAPIResource):
    ...
    async def delete_recording_sid_json(
        self,
        recording_sid: str,
        *,
        account_sid: str,
    ...
    async def retrieve_recording_sid_json(
        self,
        recording_sid: str,
        *,
        account_sid: str,
...
class JsonResourceWithRawResponse:
    def __init__(self, json: JsonResource) -> None:
        ...
        self.delete_recording_sid_json = to_raw_response_wrapper(
            json.delete_recording_sid_json,
        )
        self.retrieve_recording_sid_json = to_raw_response_wrapper(
            json.retrieve_recording_sid_json,
        )
...
class AsyncJsonResourceWithRawResponse:
    def __init__(self, json: AsyncJsonResource) -> None:
        ...
        self.delete_recording_sid_json = async_to_raw_response_wrapper(
            json.delete_recording_sid_json,
        )
        self.retrieve_recording_sid_json = async_to_raw_response_wrapper(
            json.retrieve_recording_sid_json,
        )
...
class JsonResourceWithStreamingResponse:
    def __init__(self, json: JsonResource) -> None:
        ...
        self.delete_recording_sid_json = to_streamed_response_wrapper(
            json.delete_recording_sid_json,
        )
        self.retrieve_recording_sid_json = to_streamed_response_wrapper(
            json.retrieve_recording_sid_json,
        )
...
class AsyncJsonResourceWithStreamingResponse:
    def __init__(self, json: AsyncJsonResource) -> None:
        ...
        self.delete_recording_sid_json = async_to_streamed_response_wrapper(
            json.delete_recording_sid_json,
        )
        self.retrieve_recording_sid_json = async_to_streamed_response_wrapper(
            json.retrieve_recording_sid_json,
        )
