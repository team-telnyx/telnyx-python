...
from .....types.texml.accounts.call_resource import CallResource
...
class CallsResource(SyncAPIResource):
    ...
    def calls(
        ...
        *,
        ...
        deepfake_detection_callback_method: Literal["GET", "POST"] | Omit = omit,
        deepfake_detection_callback_url: str | Omit = omit,
        ...
        Args:
          ...
          deepfake_detection: Enables Deepfake Detection on the dialed call. When enabled, audio from the
          ...
          deepfake_detection_callback_method: HTTP request type used for `DeepfakeDetectionCallbackUrl`.

          deepfake_detection_callback_url: URL destination for Telnyx to send deepfake detection callback events to for the
              call.
            ...
            body=maybe_transform(
                {
                    ...
                    "deepfake_detection_callback_method": deepfake_detection_callback_method,
                    "deepfake_detection_callback_url": deepfake_detection_callback_url,
