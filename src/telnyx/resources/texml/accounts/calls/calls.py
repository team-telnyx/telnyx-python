    ...
    def calls(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(body, call_calls_params.CallCallsParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncCallsResource(AsyncAPIResource):
    ...
    async def calls(
        ...
        *,
        ...
        return await self._post(
            path_template("/texml/Accounts/{account_sid}/Calls", account_sid=account_sid),
            body=await async_maybe_transform(body, call_calls_params.CallCallsParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=CallCallsResponse,
