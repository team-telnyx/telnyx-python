...
from ...types.number_10dlc import (
    phone_number_assignment_by_profile_retrieve_phone_numbers_params,
    phone_number_assignment_by_profile_phone_number_assignment_by_profile_params,
)
from ...types.number_10dlc.phone_number_assignment_by_profile_retrieve_response import (
    PhoneNumberAssignmentByProfileRetrieveResponse,
)
from ...types.number_10dlc.phone_number_assignment_by_profile_retrieve_phone_numbers_response import (
    PhoneNumberAssignmentByProfileRetrievePhoneNumbersResponse,
)
from ...types.number_10dlc.phone_number_assignment_by_profile_phone_number_assignment_by_profile_response import (
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=PhoneNumberAssignmentByProfileRetrieveResponse,
        )
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                phone_number_assignment_by_profile_phone_number_assignment_by_profile_params.PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileResponse,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    phone_number_assignment_by_profile_retrieve_phone_numbers_params.PhoneNumberAssignmentByProfileRetrievePhoneNumbersParams,
                ),
            ),
            cast_to=PhoneNumberAssignmentByProfileRetrievePhoneNumbersResponse,
        )
...
class AsyncPhoneNumberAssignmentByProfileResource(AsyncAPIResource):
    ...
    async def phone_number_assignment_by_profile(
        self,
        *,
        messaging_profile_id: str,
        campaign_id: str | Omit = omit,
    ...
    async def retrieve_phone_numbers(
        self,
        task_id: str,
        *,
        page: int | Omit = omit,
...
class PhoneNumberAssignmentByProfileResourceWithRawResponse:
    def __init__(self, phone_number_assignment_by_profile: PhoneNumberAssignmentByProfileResource) -> None:
        ...
        self.retrieve = to_raw_response_wrapper(
            phone_number_assignment_by_profile.retrieve,
        )
        self.phone_number_assignment_by_profile = to_raw_response_wrapper(
            phone_number_assignment_by_profile.phone_number_assignment_by_profile,
        )
        self.retrieve_phone_numbers = to_raw_response_wrapper(
            phone_number_assignment_by_profile.retrieve_phone_numbers,
        )
...
class AsyncPhoneNumberAssignmentByProfileResourceWithRawResponse:
    def __init__(self, phone_number_assignment_by_profile: AsyncPhoneNumberAssignmentByProfileResource) -> None:
        ...
        self.phone_number_assignment_by_profile = async_to_raw_response_wrapper(
            phone_number_assignment_by_profile.phone_number_assignment_by_profile,
        )
        self.retrieve_phone_numbers = async_to_raw_response_wrapper(
            phone_number_assignment_by_profile.retrieve_phone_numbers,
        )
...
class PhoneNumberAssignmentByProfileResourceWithStreamingResponse:
    def __init__(self, phone_number_assignment_by_profile: PhoneNumberAssignmentByProfileResource) -> None:
        ...
        self.phone_number_assignment_by_profile = to_streamed_response_wrapper(
            phone_number_assignment_by_profile.phone_number_assignment_by_profile,
        )
        self.retrieve_phone_numbers = to_streamed_response_wrapper(
            phone_number_assignment_by_profile.retrieve_phone_numbers,
        )
...
class AsyncPhoneNumberAssignmentByProfileResourceWithStreamingResponse:
    def __init__(self, phone_number_assignment_by_profile: AsyncPhoneNumberAssignmentByProfileResource) -> None:
        ...
        self.phone_number_assignment_by_profile = async_to_streamed_response_wrapper(
            phone_number_assignment_by_profile.phone_number_assignment_by_profile,
        )
        self.retrieve_phone_numbers = async_to_streamed_response_wrapper(
            phone_number_assignment_by_profile.retrieve_phone_numbers,
        )
