...
class Number10dlcResourceWithRawResponse:
    ...
    def brand(self) -> BrandResourceWithRawResponse:
        return BrandResourceWithRawResponse(self._number_10dlc.brand)

    @cached_property
    def campaign(self) -> CampaignResourceWithRawResponse:
        return CampaignResourceWithRawResponse(self._number_10dlc.campaign)
...
class AsyncNumber10dlcResourceWithRawResponse:
    ...
    def brand(self) -> AsyncBrandResourceWithRawResponse:
        return AsyncBrandResourceWithRawResponse(self._number_10dlc.brand)

    @cached_property
    def campaign(self) -> AsyncCampaignResourceWithRawResponse:
        return AsyncCampaignResourceWithRawResponse(self._number_10dlc.campaign)
...
class Number10dlcResourceWithStreamingResponse:
    ...
    def brand(self) -> BrandResourceWithStreamingResponse:
        return BrandResourceWithStreamingResponse(self._number_10dlc.brand)

    @cached_property
    def campaign(self) -> CampaignResourceWithStreamingResponse:
        return CampaignResourceWithStreamingResponse(self._number_10dlc.campaign)
...
class AsyncNumber10dlcResourceWithStreamingResponse:
    ...
    def brand(self) -> AsyncBrandResourceWithStreamingResponse:
        return AsyncBrandResourceWithStreamingResponse(self._number_10dlc.brand)

    @cached_property
    def campaign(self) -> AsyncCampaignResourceWithStreamingResponse:
        return AsyncCampaignResourceWithStreamingResponse(self._number_10dlc.campaign)
    ...
    def phone_number_campaigns(self) -> AsyncPhoneNumberCampaignsResourceWithStreamingResponse:
        return AsyncPhoneNumberCampaignsResourceWithStreamingResponse(self._number_10dlc.phone_number_campaigns)
