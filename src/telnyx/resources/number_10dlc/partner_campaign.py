...
from ...types.number_10dlc import partner_campaign_retrieve_shared_by_me_params
from ...types.number_10dlc.partner_campaign_retrieve_sharing_response import PartnerCampaignRetrieveSharingResponse
from ...types.number_10dlc.partner_campaign_retrieve_shared_by_me_response import (
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    partner_campaign_retrieve_shared_by_me_params.PartnerCampaignRetrieveSharedByMeParams,
                ),
            ),
            cast_to=PartnerCampaignRetrieveSharedByMeResponse,
        )
    ...
    def retrieve_sharing(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=PartnerCampaignRetrieveSharingResponse,
        )
...
class AsyncPartnerCampaignResource(AsyncAPIResource):
    ...
    async def retrieve_shared_by_me(
        self,
        *,
        page: int | Omit = omit,
        records_per_page: int | Omit = omit,
...
class PartnerCampaignResourceWithRawResponse:
    def __init__(self, partner_campaign: PartnerCampaignResource) -> None:
        ...
        self.retrieve_shared_by_me = to_raw_response_wrapper(
            partner_campaign.retrieve_shared_by_me,
        )
        self.retrieve_sharing = to_raw_response_wrapper(
            partner_campaign.retrieve_sharing,
        )
...
class AsyncPartnerCampaignResourceWithRawResponse:
    def __init__(self, partner_campaign: AsyncPartnerCampaignResource) -> None:
        ...
        self.retrieve_shared_by_me = async_to_raw_response_wrapper(
            partner_campaign.retrieve_shared_by_me,
        )
...
class PartnerCampaignResourceWithStreamingResponse:
    def __init__(self, partner_campaign: PartnerCampaignResource) -> None:
        ...
        self.retrieve_shared_by_me = to_streamed_response_wrapper(
            partner_campaign.retrieve_shared_by_me,
        )
...
class AsyncPartnerCampaignResourceWithStreamingResponse:
    def __init__(self, partner_campaign: AsyncPartnerCampaignResource) -> None:
        ...
        self.retrieve_shared_by_me = async_to_streamed_response_wrapper(
            partner_campaign.retrieve_shared_by_me,
        )
