...
class ActionsResource(SyncAPIResource):
    ...
    def start_recording(
        ...
        *,
        ...
        transcription: bool | Omit = omit,
        transcription_engine: Literal["A", "B", "deepgram/nova-3"] | Omit = omit,
        ...
        **Expected Webhooks:**
        ...
        Args:
          ...
          transcription_language: Language code for transcription. Note: Not all languages are supported by all
