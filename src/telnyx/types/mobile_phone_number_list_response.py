...
class DataCallForwarding(BaseModel):
...
class DataCallRecording(BaseModel):
...
class DataCnamListing(BaseModel):
...
class Data(BaseModel):
    ...
    call_forwarding: Optional[DataCallForwarding] = None

    call_recording: Optional[DataCallRecording] = None

    caller_id_name_enabled: Optional[bool] = None
    """Indicates if caller ID name is enabled."""

    cnam_listing: Optional[DataCnamListing] = None
...
class MobilePhoneNumberListResponse(BaseModel):
