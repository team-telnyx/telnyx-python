...
__all__ = ["NotificationSettingListParams", "Filter", "FilterCreatedAt", "FilterPhoneNumber", "FilterStatus", "Page"]


class NotificationSettingListParams(TypedDict, total=False):
    filter: Filter
