...
__all__ = ["CallStreamingFailed", "Payload", "PayloadStreamParams"]


class PayloadStreamParams(BaseModel):
...
class Payload(BaseModel):
    ...
    stream_params: Optional[PayloadStreamParams] = None
    """Streaming parameters as they were originally given to the Call Control API."""
...
class CallStreamingFailed(BaseModel):
