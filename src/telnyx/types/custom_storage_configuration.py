...
from .s3_generic_configuration_data import S3GenericConfigurationData

__all__ = ["CustomStorageConfiguration", "Configuration"]

Configuration: TypeAlias = Annotated[
    Union[GcsConfigurationData, S3ConfigurationData, S3GenericConfigurationData, AzureConfigurationData],
