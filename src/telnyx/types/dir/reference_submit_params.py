...
__all__ = ["ReferenceSubmitParams", "BusinessReference", "FinancialReference"]


class ReferenceSubmitParams(TypedDict, total=False):
    business_references: Required[Iterable[BusinessReference]]
    """Exactly two business references."""

    financial_reference: Required[FinancialReference]
...
class BusinessReference(TypedDict, total=False):
    """One reference supplied at submit.
...
class FinancialReference(TypedDict, total=False):
    """One reference supplied at submit.
