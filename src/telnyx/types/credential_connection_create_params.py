...
__all__ = ["CredentialConnectionCreateParams", "NoiseSuppressionDetails"]


class CredentialConnectionCreateParams(TypedDict, total=False):
    ...
    Note - texml can only be set when the outbound object parameter
