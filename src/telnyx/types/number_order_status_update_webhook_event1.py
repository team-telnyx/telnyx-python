...
__all__ = [
    ...
    "Data",
    "DataPayload",
    "DataPayloadPhoneNumber",
    "DataPayloadPhoneNumberRegulatoryRequirement",
    "Meta",
]


class DataPayloadPhoneNumberRegulatoryRequirement(BaseModel):
...
class DataPayloadPhoneNumber(BaseModel):
    ...
    regulatory_requirements: Optional[List[DataPayloadPhoneNumberRegulatoryRequirement]] = None
...
class DataPayload(BaseModel):
    """Number order data delivered in a webhook.

    Server-generated fields are valid in this outbound webhook request.
    """
    ...
    phone_numbers: Optional[List[DataPayloadPhoneNumber]] = None
