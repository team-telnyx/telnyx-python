...
__all__ = ["CallDeepfakeDetectionResultWebhookEvent", "Data", "DataPayload"]
...
class DataPayload(BaseModel):
    ...
    result: Optional[Literal["real", "fake", "silence_timeout"]] = None
    """Detection outcome.

    'real' = human voice, 'fake' = AI-generated voice, 'silence_timeout' = no
    analyzable speech detected before timeout.
    """
...
class Data(BaseModel):
    ...
    event_type: Optional[Literal["call.deepfake_detection.result"]] = None
...
class CallDeepfakeDetectionResultWebhookEvent(BaseModel):
