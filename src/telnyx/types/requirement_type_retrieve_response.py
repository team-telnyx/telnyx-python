...
__all__ = ["RequirementTypeRetrieveResponse", "Data", "DataAcceptanceCriteria"]


class DataAcceptanceCriteria(BaseModel):
...
class Data(BaseModel):
    ...
    acceptance_criteria: Optional[DataAcceptanceCriteria] = None
