...
__all__ = [
    ...
    "DataCost",
    "DataCostBreakdown",
    "DataCostBreakdownCarrierFee",
    "DataCostBreakdownRate",
    "DataFrom",
    "DataMedia",
    "DataTo",
]
...
class DataCostBreakdownCarrierFee(BaseModel):
    amount: Optional[str] = None
...
class DataCostBreakdownRate(BaseModel):
    amount: Optional[str] = None
...
class DataCostBreakdown(BaseModel):
    carrier_fee: Optional[DataCostBreakdownCarrierFee] = None

    rate: Optional[DataCostBreakdownRate] = None
...
class Data(BaseModel):
    ...
    cost_breakdown: Optional[DataCostBreakdown] = None
...
class MessageSendGroupMmsResponse(BaseModel):
