...
__all__ = ["ConferenceRecordingSaved", "Payload", "PayloadPublicRecordingURLs", "PayloadRecordingURLs"]


class PayloadPublicRecordingURLs(BaseModel):
...
class PayloadRecordingURLs(BaseModel):
    """Recording URLs in requested format.
...
class Payload(BaseModel):
    ...
    public_recording_urls: Optional[PayloadPublicRecordingURLs] = None
    """Recording URLs in requested format.
    ...
    recording_urls: Optional[PayloadRecordingURLs] = None
    """Recording URLs in requested format.
