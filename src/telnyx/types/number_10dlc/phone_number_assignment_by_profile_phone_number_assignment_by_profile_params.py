...
__all__ = ["PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams"]


class PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams(TypedDict, total=False):
