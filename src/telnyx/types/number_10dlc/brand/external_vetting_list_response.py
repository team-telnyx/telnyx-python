...
__all__ = ["ExternalVettingListResponse", "ExternalVettingListResponseItem"]


class ExternalVettingListResponseItem(BaseModel):
...
ExternalVettingListResponse: TypeAlias = List[ExternalVettingListResponseItem]
