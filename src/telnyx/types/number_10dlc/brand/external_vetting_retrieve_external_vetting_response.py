...
__all__ = ["ExternalVettingRetrieveExternalVettingResponse", "ExternalVettingRetrieveExternalVettingResponseItem"]


class ExternalVettingRetrieveExternalVettingResponseItem(BaseModel):
...
ExternalVettingRetrieveExternalVettingResponse: TypeAlias = List[ExternalVettingRetrieveExternalVettingResponseItem]
