...
__all__ = ["PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileResponse"]


class PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileResponse(BaseModel):
