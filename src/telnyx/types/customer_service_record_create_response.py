...
__all__ = ["CustomerServiceRecordCreateResponse", "Data", "DataResult", "DataResultAddress", "DataResultAdmin"]


class DataResultAddress(BaseModel):
...
class DataResultAdmin(BaseModel):
...
class DataResult(BaseModel):
    address: Optional[DataResultAddress] = None
    """The address of the customer service record"""

    admin: Optional[DataResultAdmin] = None
...
class CustomerServiceRecordCreateResponse(BaseModel):
