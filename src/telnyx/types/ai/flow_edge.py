...
class ConditionLlmCondition(BaseModel):
...
class ConditionExpressionCondition(BaseModel):
...
class ConditionDefaultCondition(BaseModel):
...
Condition: TypeAlias = Annotated[
    Union[ConditionLlmCondition, ConditionExpressionCondition, ConditionDefaultCondition],
    PropertyInfo(discriminator="type"),
]


class TargetNodeTarget(BaseModel):
...
class TargetAssistantTarget(BaseModel):
...
Target: TypeAlias = Annotated[Union[TargetNodeTarget, TargetAssistantTarget], PropertyInfo(discriminator="type")]
