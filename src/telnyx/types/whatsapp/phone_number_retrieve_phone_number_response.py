...
__all__ = ["PhoneNumberRetrievePhoneNumberResponse", "Data", "DataSyncProgress"]


class DataSyncProgress(BaseModel):
...
class Data(BaseModel):
    ...
    sync_progress: Optional[DataSyncProgress] = None
    """Synchronization progress.
...
class PhoneNumberRetrievePhoneNumberResponse(BaseModel):
    data: Data
