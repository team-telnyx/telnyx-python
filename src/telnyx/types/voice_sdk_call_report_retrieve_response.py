...
__all__ = [
    ...
    "VoiceSDKCallReportRetrieveResponseItem",
    "VoiceSDKCallReportRetrieveResponseItemLogs",
    "VoiceSDKCallReportRetrieveResponseItemLogsUnionMember0",
    "VoiceSDKCallReportRetrieveResponseItemLogsEntries",
    "VoiceSDKCallReportRetrieveResponseItemLogsEntriesEntry",
    "VoiceSDKCallReportRetrieveResponseItemStats",
    "VoiceSDKCallReportRetrieveResponseItemStatsUnionMember1",
]


class VoiceSDKCallReportRetrieveResponseItemLogsUnionMember0(BaseModel):
...
class VoiceSDKCallReportRetrieveResponseItemLogsEntriesEntry(BaseModel):
    """A raw Voice SDK log entry. Additional SDK-specific fields may be present."""
...
class VoiceSDKCallReportRetrieveResponseItemLogsEntries(BaseModel):
    """
    Raw logs object emitted by the Voice SDK when logs are grouped under an entries field.
    """

    entries: Optional[List[VoiceSDKCallReportRetrieveResponseItemLogsEntriesEntry]] = None
...
VoiceSDKCallReportRetrieveResponseItemLogs: TypeAlias = Union[
    List[VoiceSDKCallReportRetrieveResponseItemLogsUnionMember0], VoiceSDKCallReportRetrieveResponseItemLogsEntries
]


class VoiceSDKCallReportRetrieveResponseItemStatsUnionMember1(BaseModel):
...
VoiceSDKCallReportRetrieveResponseItemStats: TypeAlias = Union[
    List[Dict[str, object]], VoiceSDKCallReportRetrieveResponseItemStatsUnionMember1
]


class VoiceSDKCallReportRetrieveResponseItem(BaseModel):
    ...
    logs: Optional[VoiceSDKCallReportRetrieveResponseItemLogs] = None
    ...
    stats: Optional[VoiceSDKCallReportRetrieveResponseItemStats] = None
...
VoiceSDKCallReportRetrieveResponse: TypeAlias = List[VoiceSDKCallReportRetrieveResponseItem]
