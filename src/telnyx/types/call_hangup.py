...
class PayloadCallQualityStatsInbound(BaseModel):
...
class PayloadCallQualityStatsOutbound(BaseModel):
...
class PayloadCallQualityStats(BaseModel):
    ...
    inbound: Optional[PayloadCallQualityStatsInbound] = None
    """Inbound call quality statistics."""
...
class Payload(BaseModel):
    ...
    call_quality_stats: Optional[PayloadCallQualityStats] = None
    """Call quality statistics aggregated from the CHANNEL_HANGUP_COMPLETE event.
